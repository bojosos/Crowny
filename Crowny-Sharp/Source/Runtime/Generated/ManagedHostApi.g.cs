...
namespace Crowny
{
    ...
    internal static unsafe class ManagedHostTransport
    {
        ...
        internal static void SetApi(ManagedNativeHostApi value)
        {
            ...
            if (value.AbiVersion != 19 || value.Size < (uint)Marshal.SizeOf(typeof(ManagedNativeHostApi)))
            ...
            Physics2DSetGravityCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall100>(value.Physics2DSetGravity);
            ...
            Physics2DSetVelocityIterationsCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall101>(value.Physics2DSetVelocityIterations);
            ...
            Physics2DSetPositionIterationsCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall101>(value.Physics2DSetPositionIterations);
            ...
            Physics2DSetDefaultMaterialCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall102>(value.Physics2DSetDefaultMaterial);
            Physics2DGetLayerNameCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall92>(value.Physics2DGetLayerName);
            Physics2DSetLayerNameCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall103>(value.Physics2DSetLayerName);
            Physics2DGetLayerMaskCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall104>(value.Physics2DGetLayerMask);
            Physics2DSetLayerMaskCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall105>(value.Physics2DSetLayerMask);
            Physics2DResolveEntityCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall106>(value.Physics2DResolveEntity);
            Physics2DRaycastCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall107>(value.Physics2DRaycast);
            Physics3DGetBackendCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall94>(value.Physics3DGetBackend);
            Physics3DGetBackendNameCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall108>(value.Physics3DGetBackendName);
            Physics3DGetIsSimulatingCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall20>(value.Physics3DGetIsSimulating);
            Physics3DGetCapabilitiesCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall109>(value.Physics3DGetCapabilities);
            Physics3DGetGravityCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall90>(value.Physics3DGetGravity);
            Physics3DSetGravityCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall110>(value.Physics3DSetGravity);
            Physics3DGetSubstepsCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall22>(value.Physics3DGetSubsteps);
            Physics3DSetSubstepsCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall101>(value.Physics3DSetSubsteps);
            ...
            Physics3DSetDefaultMaterialCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall102>(value.Physics3DSetDefaultMaterial);
            Physics3DTrySetBackendCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall111>(value.Physics3DTrySetBackend);
            Physics3DIsBackendAvailableCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall111>(value.Physics3DIsBackendAvailable);
            Physics3DResolveEntityCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall112>(value.Physics3DResolveEntity);
            Physics3DRaycastCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall113>(value.Physics3DRaycast);
            Physics3DSweepCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall114>(value.Physics3DSweep);
            Physics3DOverlapCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall115>(value.Physics3DOverlap);
            ...
            MeshCopyVerticesCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall116>(value.MeshCopyVertices);
            MeshSetVerticesCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall117>(value.MeshSetVertices);
            MeshCopyNormalsCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall116>(value.MeshCopyNormals);
            MeshSetNormalsCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall117>(value.MeshSetNormals);
            MeshCopyUvsCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall118>(value.MeshCopyUvs);
            MeshSetUvsCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall119>(value.MeshSetUvs);
            MeshCopyColorsCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall116>(value.MeshCopyColors);
            MeshSetColorsCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall117>(value.MeshSetColors);
            MeshCopyIndicesCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall116>(value.MeshCopyIndices);
            MeshSetIndicesCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall117>(value.MeshSetIndices);
            ...
            MeshGetBoundsMinCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall120>(value.MeshGetBoundsMin);
            MeshGetBoundsMaxCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall120>(value.MeshGetBoundsMax);
            MeshSetVertexBufferParamsCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall121>(value.MeshSetVertexBufferParams);
            MeshSetVertexBufferDataCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall122>(value.MeshSetVertexBufferData);
            MeshGetVertexBufferDataCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall123>(value.MeshGetVertexBufferData);
            ...
            MeshHasVertexAttributeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall124>(value.MeshHasVertexAttribute);
            MeshGetVertexAttributeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall125>(value.MeshGetVertexAttribute);
            MeshCreatePlaneCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall126>(value.MeshCreatePlane);
            MeshCreateBoxCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall127>(value.MeshCreateBox);
            MeshCreateCubeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall128>(value.MeshCreateCube);
            MeshCreateSphereCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall129>(value.MeshCreateSphere);
            MeshCreateCylinderCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall130>(value.MeshCreateCylinder);
            MeshCreateConeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall130>(value.MeshCreateCone);
            MeshCreateCapsuleCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall131>(value.MeshCreateCapsule);
            MeshRendererGetMaterialCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall132>(value.MeshRendererGetMaterial);
            MeshRendererSetMaterialCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall133>(value.MeshRendererSetMaterial);
            MathMatrixDeterminantCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall134>(value.MathMatrixDeterminant);
            MathMatrixInverseCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall135>(value.MathMatrixInverse);
            MathMatrixAffineInverseCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall135>(value.MathMatrixAffineInverse);
            MathLookAtCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall136>(value.MathLookAt);
            AddScriptComponentCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall137>(value.AddScriptComponent);
            RemoveScriptComponentCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall137>(value.RemoveScriptComponent);
            ...
            Collider3DGetCollisionFilterCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall138>(value.Collider3DGetCollisionFilter);
            Collider3DSetCollisionFilterCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall139>(value.Collider3DSetCollisionFilter);
            ...
            Rigidbody3DGetCollisionFilterCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall138>(value.Rigidbody3DGetCollisionFilter);
            Rigidbody3DSetCollisionFilterCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall139>(value.Rigidbody3DSetCollisionFilter);
            ...
            Rigidbody3DGetBodyHandleCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall140>(value.Rigidbody3DGetBodyHandle);
            ...
            PhysicsMaterial2DSetDensityCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall141>(value.PhysicsMaterial2DSetDensity);
            ...
            PhysicsMaterial2DSetFrictionCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall141>(value.PhysicsMaterial2DSetFriction);
            ...
            PhysicsMaterial2DSetRestitutionCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall141>(value.PhysicsMaterial2DSetRestitution);
            ...
            PhysicsMaterial2DSetRestitutionThresholdCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall141>(value.PhysicsMaterial2DSetRestitutionThreshold);
            ...
            PhysicsMaterial2DSetFrictionCombineCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall142>(value.PhysicsMaterial2DSetFrictionCombine);
            ...
            PhysicsMaterial2DSetRestitutionCombineCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall142>(value.PhysicsMaterial2DSetRestitutionCombine);
            ...
            PhysicsMaterial3DSetDensityCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall141>(value.PhysicsMaterial3DSetDensity);
            ...
            PhysicsMaterial3DSetFrictionCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall141>(value.PhysicsMaterial3DSetFriction);
            ...
            PhysicsMaterial3DSetRestitutionCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall141>(value.PhysicsMaterial3DSetRestitution);
            ...
            PhysicsMaterial3DSetRestitutionThresholdCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall141>(value.PhysicsMaterial3DSetRestitutionThreshold);
            ...
            PhysicsMaterial3DSetFrictionCombineCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall142>(value.PhysicsMaterial3DSetFrictionCombine);
            ...
            PhysicsMaterial3DSetRestitutionCombineCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall142>(value.PhysicsMaterial3DSetRestitutionCombine);
            ...
            TextSetTextCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall143>(value.TextSetText);
            ...
            Collider2DGetMaterialOverrideCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall144>(value.Collider2DGetMaterialOverride);
            Collider2DSetMaterialOverrideCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall145>(value.Collider2DSetMaterialOverride);
            Collider3DGetMaterialOverrideCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall144>(value.Collider3DGetMaterialOverride);
            Collider3DSetMaterialOverrideCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall145>(value.Collider3DSetMaterialOverride);
            api = value;
        }
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall100(void* context, ManagedNativeVec2* value);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall101(void* context, uint value);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall102(void* context, ManagedNativeUuid material);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall103(void* context, int layer, ManagedNativeStringView name);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall104(void* context, int layer, uint* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall105(void* context, int layer, uint mask);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall106(void* context, uint runtimeId, ManagedNativeUuid* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall107(void* context, ManagedNativeVec2* origin, ManagedNativeVec2* direction, float distance, uint layerMask, void* destination, uint capacity, uint* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall108(void* context, ManagedNativeStringView* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall109(void* context, ulong* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall110(void* context, ManagedNativeVec3* value);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall111(void* context, int value, byte* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall112(void* context, ulong runtimeId, ManagedNativeUuid* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall113(void* context, ManagedNativeVec3* origin, ManagedNativeVec3* direction, float distance, uint layerMask, byte includeTriggers, ulong ignoreBodyHandle, void* destination, uint capacity, uint* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall114(void* context, int shapeType, ManagedNativeVec3* size, float radius, float height, ManagedNativeVec3* position, ManagedNativeQuaternion* rotation, ManagedNativeVec3* direction, float distance, uint layerMask, byte includeTriggers, ulong ignoreBodyHandle, void* destination, uint capacity, uint* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall115(void* context, int shapeType, ManagedNativeVec3* size, float radius, float height, ManagedNativeVec3* position, ManagedNativeQuaternion* rotation, uint layerMask, byte includeTriggers, ulong ignoreBodyHandle, void* destination, uint capacity, uint* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall116(void* context, ManagedNativeUuid asset, void* destination, uint capacity, uint* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall117(void* context, ManagedNativeUuid asset, void* source, uint count);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall118(void* context, ManagedNativeUuid asset, uint channel, void* destination, uint capacity, uint* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall119(void* context, ManagedNativeUuid asset, uint channel, void* source, uint count);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall120(void* context, ManagedNativeUuid asset, ManagedNativeVec3* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall121(void* context, ManagedNativeUuid asset, uint vertexCount, void* layout, uint layoutCount);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall122(void* context, ManagedNativeUuid asset, void* source, uint meshBufferStart, uint count, uint stride);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall123(void* context, ManagedNativeUuid asset, void* destination, uint capacity, uint stride, uint* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall124(void* context, ManagedNativeUuid asset, int attribute, byte* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall125(void* context, ManagedNativeUuid asset, int index, void* destination);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall126(void* context, float width, float height, uint subdivisionsX, uint subdivisionsY, ManagedNativeUuid* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall127(void* context, ManagedNativeVec3* dimensions, ManagedNativeUuid* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall128(void* context, float size, ManagedNativeUuid* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall129(void* context, float radius, uint segments, uint rings, ManagedNativeUuid* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall130(void* context, float radius, float height, uint segments, byte capped, ManagedNativeUuid* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall131(void* context, float radius, float height, uint segments, uint hemisphereRings, ManagedNativeUuid* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall132(void* context, ManagedNativeUuid entity, uint index, ManagedNativeUuid* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall133(void* context, ManagedNativeUuid entity, uint index, ManagedNativeUuid material);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall134(void* context, ManagedNativeMatrix4* matrix, float* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall135(void* context, ManagedNativeMatrix4* matrix, ManagedNativeMatrix4* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall136(void* context, ManagedNativeVec3* from, ManagedNativeVec3* to, ManagedNativeVec3* up, ManagedNativeMatrix4* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall137(void* context, ManagedNativeUuid entity, ManagedNativeStringView assemblyName, ManagedNativeStringView namespaceName, ManagedNativeStringView typeName);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall138(void* context, ManagedNativeUuid entity, ManagedNativePhysicsFilter3D* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall139(void* context, ManagedNativeUuid entity, ManagedNativePhysicsFilter3D* value);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall140(void* context, ManagedNativeUuid entity, ulong* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall141(void* context, ManagedNativeUuid asset, float value);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall142(void* context, ManagedNativeUuid asset, int value);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall143(void* context, ManagedNativeUuid entity, ManagedNativeStringView value);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall144(void* context, ManagedNativeUuid entity, ManagedNativePhysicsMaterialOverride* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall145(void* context, ManagedNativeUuid entity, ManagedNativePhysicsMaterialOverride* value);
        ...
        private static ManagedHostCall100 Physics2DSetGravityCallback;
        private static ManagedHostCall22 Physics2DGetVelocityIterationsCallback;
        private static ManagedHostCall101 Physics2DSetVelocityIterationsCallback;
        private static ManagedHostCall22 Physics2DGetPositionIterationsCallback;
        private static ManagedHostCall101 Physics2DSetPositionIterationsCallback;
        private static ManagedHostCall66 Physics2DGetDefaultMaterialCallback;
        private static ManagedHostCall102 Physics2DSetDefaultMaterialCallback;
        private static ManagedHostCall92 Physics2DGetLayerNameCallback;
        private static ManagedHostCall103 Physics2DSetLayerNameCallback;
        private static ManagedHostCall104 Physics2DGetLayerMaskCallback;
        private static ManagedHostCall105 Physics2DSetLayerMaskCallback;
        private static ManagedHostCall106 Physics2DResolveEntityCallback;
        private static ManagedHostCall107 Physics2DRaycastCallback;
        private static ManagedHostCall94 Physics3DGetBackendCallback;
        private static ManagedHostCall108 Physics3DGetBackendNameCallback;
        private static ManagedHostCall20 Physics3DGetIsSimulatingCallback;
        private static ManagedHostCall109 Physics3DGetCapabilitiesCallback;
        private static ManagedHostCall90 Physics3DGetGravityCallback;
        private static ManagedHostCall110 Physics3DSetGravityCallback;
        private static ManagedHostCall22 Physics3DGetSubstepsCallback;
        private static ManagedHostCall101 Physics3DSetSubstepsCallback;
        private static ManagedHostCall66 Physics3DGetDefaultMaterialCallback;
        private static ManagedHostCall102 Physics3DSetDefaultMaterialCallback;
        private static ManagedHostCall111 Physics3DTrySetBackendCallback;
        private static ManagedHostCall111 Physics3DIsBackendAvailableCallback;
        private static ManagedHostCall112 Physics3DResolveEntityCallback;
        private static ManagedHostCall113 Physics3DRaycastCallback;
        private static ManagedHostCall114 Physics3DSweepCallback;
        private static ManagedHostCall115 Physics3DOverlapCallback;
        private static ManagedHostCall52 MeshGetVertexCountCallback;
        private static ManagedHostCall52 MeshGetIndexCountCallback;
        private static ManagedHostCall116 MeshCopyVerticesCallback;
        private static ManagedHostCall117 MeshSetVerticesCallback;
        private static ManagedHostCall116 MeshCopyNormalsCallback;
        private static ManagedHostCall117 MeshSetNormalsCallback;
        private static ManagedHostCall118 MeshCopyUvsCallback;
        private static ManagedHostCall119 MeshSetUvsCallback;
        private static ManagedHostCall116 MeshCopyColorsCallback;
        private static ManagedHostCall117 MeshSetColorsCallback;
        private static ManagedHostCall116 MeshCopyIndicesCallback;
        private static ManagedHostCall117 MeshSetIndicesCallback;
        ...
        private static ManagedHostCall120 MeshGetBoundsMinCallback;
        private static ManagedHostCall120 MeshGetBoundsMaxCallback;
        private static ManagedHostCall121 MeshSetVertexBufferParamsCallback;
        private static ManagedHostCall122 MeshSetVertexBufferDataCallback;
        private static ManagedHostCall123 MeshGetVertexBufferDataCallback;
        ...
        private static ManagedHostCall124 MeshHasVertexAttributeCallback;
        private static ManagedHostCall125 MeshGetVertexAttributeCallback;
        private static ManagedHostCall126 MeshCreatePlaneCallback;
        private static ManagedHostCall127 MeshCreateBoxCallback;
        private static ManagedHostCall128 MeshCreateCubeCallback;
        private static ManagedHostCall129 MeshCreateSphereCallback;
        private static ManagedHostCall130 MeshCreateCylinderCallback;
        private static ManagedHostCall130 MeshCreateConeCallback;
        private static ManagedHostCall131 MeshCreateCapsuleCallback;
        private static ManagedHostCall132 MeshRendererGetMaterialCallback;
        private static ManagedHostCall133 MeshRendererSetMaterialCallback;
        private static ManagedHostCall134 MathMatrixDeterminantCallback;
        private static ManagedHostCall135 MathMatrixInverseCallback;
        private static ManagedHostCall135 MathMatrixAffineInverseCallback;
        private static ManagedHostCall136 MathLookAtCallback;
        private static ManagedHostCall137 AddScriptComponentCallback;
        private static ManagedHostCall137 RemoveScriptComponentCallback;
        ...
        private static ManagedHostCall138 Collider3DGetCollisionFilterCallback;
        private static ManagedHostCall139 Collider3DSetCollisionFilterCallback;
        ...
        private static ManagedHostCall138 Rigidbody3DGetCollisionFilterCallback;
        private static ManagedHostCall139 Rigidbody3DSetCollisionFilterCallback;
        ...
        private static ManagedHostCall140 Rigidbody3DGetBodyHandleCallback;
        private static ManagedHostCall51 PhysicsMaterial2DGetDensityCallback;
        private static ManagedHostCall141 PhysicsMaterial2DSetDensityCallback;
        private static ManagedHostCall51 PhysicsMaterial2DGetFrictionCallback;
        private static ManagedHostCall141 PhysicsMaterial2DSetFrictionCallback;
        private static ManagedHostCall51 PhysicsMaterial2DGetRestitutionCallback;
        private static ManagedHostCall141 PhysicsMaterial2DSetRestitutionCallback;
        private static ManagedHostCall51 PhysicsMaterial2DGetRestitutionThresholdCallback;
        private static ManagedHostCall141 PhysicsMaterial2DSetRestitutionThresholdCallback;
        private static ManagedHostCall50 PhysicsMaterial2DGetFrictionCombineCallback;
        private static ManagedHostCall142 PhysicsMaterial2DSetFrictionCombineCallback;
        private static ManagedHostCall50 PhysicsMaterial2DGetRestitutionCombineCallback;
        private static ManagedHostCall142 PhysicsMaterial2DSetRestitutionCombineCallback;
        private static ManagedHostCall51 PhysicsMaterial3DGetDensityCallback;
        private static ManagedHostCall141 PhysicsMaterial3DSetDensityCallback;
        private static ManagedHostCall51 PhysicsMaterial3DGetFrictionCallback;
        private static ManagedHostCall141 PhysicsMaterial3DSetFrictionCallback;
        private static ManagedHostCall51 PhysicsMaterial3DGetRestitutionCallback;
        private static ManagedHostCall141 PhysicsMaterial3DSetRestitutionCallback;
        private static ManagedHostCall51 PhysicsMaterial3DGetRestitutionThresholdCallback;
        private static ManagedHostCall141 PhysicsMaterial3DSetRestitutionThresholdCallback;
        private static ManagedHostCall50 PhysicsMaterial3DGetFrictionCombineCallback;
        private static ManagedHostCall142 PhysicsMaterial3DSetFrictionCombineCallback;
        private static ManagedHostCall50 PhysicsMaterial3DGetRestitutionCombineCallback;
        private static ManagedHostCall142 PhysicsMaterial3DSetRestitutionCombineCallback;
        ...
        private static ManagedHostCall143 TextSetTextCallback;
        ...
        private static ManagedHostCall144 Collider2DGetMaterialOverrideCallback;
        private static ManagedHostCall145 Collider2DSetMaterialOverrideCallback;
        private static ManagedHostCall144 Collider3DGetMaterialOverrideCallback;
        private static ManagedHostCall145 Collider3DSetMaterialOverrideCallback;
