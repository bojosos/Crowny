...
namespace Crowny
{
    ...
    internal static unsafe class ManagedHostTransport
    {
        ...
        internal static void SetApi(ManagedNativeHostApi value)
        {
            ...
            if (value.AbiVersion != 18 || value.Size < (uint)Marshal.SizeOf(typeof(ManagedNativeHostApi)))
            ...
            InputSetMouseGrabbedCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall17>(value.InputSetMouseGrabbed);
            InputIsMouseGrabbedCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall18>(value.InputIsMouseGrabbed);
            InputSetCursorTypeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall19>(value.InputSetCursorType);
            InputGetCursorTypeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall20>(value.InputGetCursorType);
            InputIsGamepadConnectedCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall21>(value.InputIsGamepadConnected);
            InputGetGamepadButtonCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall22>(value.InputGetGamepadButton);
            InputGetGamepadButtonDownCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall22>(value.InputGetGamepadButtonDown);
            InputGetGamepadButtonUpCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall22>(value.InputGetGamepadButtonUp);
            InputGetGamepadAxisCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall23>(value.InputGetGamepadAxis);
            InputEnableActionMapCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall24>(value.InputEnableActionMap);
            InputDisableActionMapCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall24>(value.InputDisableActionMap);
            InputGetActionCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall25>(value.InputGetAction);
            InputGetActionDownCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall25>(value.InputGetActionDown);
            InputGetActionUpCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall25>(value.InputGetActionUp);
            InputGetAxisCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall26>(value.InputGetAxis);
            InputGetActionVectorCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall27>(value.InputGetActionVector);
            InputClearActionRebindsCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall28>(value.InputClearActionRebinds);
            ...
            TimeGetFrameCountCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall20>(value.TimeGetFrameCount);
            ScreenGetSizeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall16>(value.ScreenGetSize);
            Rigidbody2DGetMassCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall29>(value.Rigidbody2DGetMass);
            Rigidbody2DSetMassCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall30>(value.Rigidbody2DSetMass);
            Rigidbody2DGetBodyTypeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall31>(value.Rigidbody2DGetBodyType);
            Rigidbody2DSetBodyTypeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall32>(value.Rigidbody2DSetBodyType);
            Rigidbody2DGetSleepModeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall31>(value.Rigidbody2DGetSleepMode);
            Rigidbody2DSetSleepModeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall32>(value.Rigidbody2DSetSleepMode);
            Rigidbody2DGetCollisionDetectionModeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall31>(value.Rigidbody2DGetCollisionDetectionMode);
            Rigidbody2DSetCollisionDetectionModeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall32>(value.Rigidbody2DSetCollisionDetectionMode);
            Rigidbody2DGetInterpolationCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall31>(value.Rigidbody2DGetInterpolation);
            Rigidbody2DSetInterpolationCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall32>(value.Rigidbody2DSetInterpolation);
            Rigidbody2DGetAutoMassCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall33>(value.Rigidbody2DGetAutoMass);
            Rigidbody2DSetAutoMassCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall34>(value.Rigidbody2DSetAutoMass);
            Rigidbody2DGetLayerCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall31>(value.Rigidbody2DGetLayer);
            Rigidbody2DSetLayerCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall32>(value.Rigidbody2DSetLayer);
            Rigidbody2DGetLinearDragCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall29>(value.Rigidbody2DGetLinearDrag);
            Rigidbody2DSetLinearDragCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall30>(value.Rigidbody2DSetLinearDrag);
            Rigidbody2DGetAngularDragCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall29>(value.Rigidbody2DGetAngularDrag);
            Rigidbody2DSetAngularDragCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall30>(value.Rigidbody2DSetAngularDrag);
            Rigidbody2DGetGravityScaleCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall29>(value.Rigidbody2DGetGravityScale);
            Rigidbody2DSetGravityScaleCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall30>(value.Rigidbody2DSetGravityScale);
            Rigidbody2DGetCenterOfMassCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall35>(value.Rigidbody2DGetCenterOfMass);
            Rigidbody2DSetCenterOfMassCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall36>(value.Rigidbody2DSetCenterOfMass);
            Rigidbody2DGetInertiaCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall29>(value.Rigidbody2DGetInertia);
            Rigidbody2DSetInertiaCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall30>(value.Rigidbody2DSetInertia);
            Rigidbody2DGetConstraintsCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall37>(value.Rigidbody2DGetConstraints);
            Rigidbody2DSetConstraintsCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall38>(value.Rigidbody2DSetConstraints);
            Rigidbody2DGetRotationCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall29>(value.Rigidbody2DGetRotation);
            Rigidbody2DGetPositionCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall35>(value.Rigidbody2DGetPosition);
            Rigidbody2DGetLinearVelocityCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall35>(value.Rigidbody2DGetLinearVelocity);
            Rigidbody2DSetLinearVelocityCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall36>(value.Rigidbody2DSetLinearVelocity);
            Rigidbody2DGetAngularVelocityCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall29>(value.Rigidbody2DGetAngularVelocity);
            Rigidbody2DSetAngularVelocityCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall30>(value.Rigidbody2DSetAngularVelocity);
            Rigidbody2DGetAwakeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall33>(value.Rigidbody2DGetAwake);
            Rigidbody2DSetAwakeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall34>(value.Rigidbody2DSetAwake);
            Rigidbody2DAddForceCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall39>(value.Rigidbody2DAddForce);
            Rigidbody2DAddForceAtPositionCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall40>(value.Rigidbody2DAddForceAtPosition);
            Rigidbody2DAddTorqueCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall41>(value.Rigidbody2DAddTorque);
            AudioSourceGetVolumeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall29>(value.AudioSourceGetVolume);
            AudioSourceSetVolumeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall30>(value.AudioSourceSetVolume);
            AudioSourceGetPitchCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall29>(value.AudioSourceGetPitch);
            AudioSourceSetPitchCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall30>(value.AudioSourceSetPitch);
            AudioSourceGetMinDistanceCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall29>(value.AudioSourceGetMinDistance);
            AudioSourceSetMinDistanceCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall30>(value.AudioSourceSetMinDistance);
            AudioSourceGetMaxDistanceCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall29>(value.AudioSourceGetMaxDistance);
            AudioSourceSetMaxDistanceCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall30>(value.AudioSourceSetMaxDistance);
            AudioSourceGetLoopCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall33>(value.AudioSourceGetLoop);
            AudioSourceSetLoopCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall34>(value.AudioSourceSetLoop);
            AudioSourceGetMutedCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall33>(value.AudioSourceGetMuted);
            AudioSourceSetMutedCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall34>(value.AudioSourceSetMuted);
            AudioSourceGetPlayOnAwakeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall33>(value.AudioSourceGetPlayOnAwake);
            AudioSourceSetPlayOnAwakeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall34>(value.AudioSourceSetPlayOnAwake);
            AudioSourceGetTimeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall29>(value.AudioSourceGetTime);
            AudioSourceSetTimeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall30>(value.AudioSourceSetTime);
            AudioSourceGetClipCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall3>(value.AudioSourceGetClip);
            AudioSourceSetClipCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall42>(value.AudioSourceSetClip);
            AudioSourceGetStateCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall31>(value.AudioSourceGetState);
            ...
            AssetGetNameCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall43>(value.AssetGetName);
            AssetAcquireCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall44>(value.AssetAcquire);
            AssetReleaseCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall44>(value.AssetRelease);
            AssetDatabaseLoadCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall45>(value.AssetDatabaseLoad);
            AssetDatabaseLoadFromUuidCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall46>(value.AssetDatabaseLoadFromUuid);
            AssetDatabaseGetPathCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall43>(value.AssetDatabaseGetPath);
            AssetDatabaseIsValidCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall47>(value.AssetDatabaseIsValid);
            AudioClipGetBitDepthCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall48>(value.AudioClipGetBitDepth);
            AudioClipGetChannelsCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall48>(value.AudioClipGetChannels);
            AudioClipGetFrequencyCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall48>(value.AudioClipGetFrequency);
            AudioClipGetSamplesCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall48>(value.AudioClipGetSamples);
            AudioClipGetLengthCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall49>(value.AudioClipGetLength);
            AudioClipGetReadModeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall48>(value.AudioClipGetReadMode);
            AudioClipGetFormatCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall48>(value.AudioClipGetFormat);
            AudioClipGetIs3DCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall47>(value.AudioClipGetIs3D);
            TextureGetWidthCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall50>(value.TextureGetWidth);
            TextureGetHeightCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall50>(value.TextureGetHeight);
            AudioMixerSetActiveCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall44>(value.AudioMixerSetActive);
            AudioMixerGetBusVolumeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall51>(value.AudioMixerGetBusVolume);
            AudioMixerSetBusVolumeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall52>(value.AudioMixerSetBusVolume);
            AudioMixerIsBusMutedCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall53>(value.AudioMixerIsBusMuted);
            AudioMixerSetBusMutedCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall54>(value.AudioMixerSetBusMuted);
            MaterialSetFloatCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall55>(value.MaterialSetFloat);
            MaterialSetVector2Callback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall56>(value.MaterialSetVector2);
            MaterialSetIntCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall57>(value.MaterialSetInt);
            MaterialSetColorCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall58>(value.MaterialSetColor);
            MaterialSetVector3Callback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall59>(value.MaterialSetVector3);
            MaterialSetMatrixCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall60>(value.MaterialSetMatrix);
            MaterialSetTextureCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall61>(value.MaterialSetTexture);
            MaterialHasAlphaModeOverrideCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall47>(value.MaterialHasAlphaModeOverride);
            MaterialGetAlphaModeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall48>(value.MaterialGetAlphaMode);
            MaterialSetAlphaModeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall62>(value.MaterialSetAlphaMode);
            MaterialClearAlphaModeOverrideCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall44>(value.MaterialClearAlphaModeOverride);
            MaterialApplyToonPresetCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall63>(value.MaterialApplyToonPreset);
            PhysicsMaterial2DCreateCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall64>(value.PhysicsMaterial2DCreate);
            PhysicsMaterial3DCreateCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall64>(value.PhysicsMaterial3DCreate);
            Rigidbody3DAddForceCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall65>(value.Rigidbody3DAddForce);
            Rigidbody3DAddForceAtCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall66>(value.Rigidbody3DAddForceAt);
            Rigidbody3DAddTorqueCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall67>(value.Rigidbody3DAddTorque);
            CompressionCompressCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall68>(value.CompressionCompress);
            CompressionDecompressCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall69>(value.CompressionDecompress);
            FileDialogOpenFileCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall70>(value.FileDialogOpenFile);
            FileDialogOpenFolderCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall71>(value.FileDialogOpenFolder);
            FileDialogSaveFileCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall72>(value.FileDialogSaveFile);
            FileDialogSaveFolderCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall73>(value.FileDialogSaveFolder);
            FontHasCharacterCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall74>(value.FontHasCharacter);
            FontGetIsValidCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall75>(value.FontGetIsValid);
            FontGetGlyphCountCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall76>(value.FontGetGlyphCount);
            FontGetTabWidthCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall76>(value.FontGetTabWidth);
            FontGetAtlasWidthCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall76>(value.FontGetAtlasWidth);
            FontGetAtlasHeightCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall76>(value.FontGetAtlasHeight);
            FontGetAtlasPixelRangeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall77>(value.FontGetAtlasPixelRange);
            FontGetFallbackCountCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall76>(value.FontGetFallbackCount);
            FontHasGlyphCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall78>(value.FontHasGlyph);
            FontGetCharacterInfoCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall79>(value.FontGetCharacterInfo);
            FontGetFallbackCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall80>(value.FontGetFallback);
            FontAddFallbackCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall81>(value.FontAddFallback);
            FontClearFallbacksCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall82>(value.FontClearFallbacks);
            FontGetSystemFontCountCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall20>(value.FontGetSystemFontCount);
            FontGetSystemFontPathCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall83>(value.FontGetSystemFontPath);
            FontGetSystemFontNameCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall83>(value.FontGetSystemFontName);
            AnimationClipGetLengthCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall49>(value.AnimationClipGetLength);
            AnimationClipGetSampleRateCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall49>(value.AnimationClipGetSampleRate);
            AnimationClipGetIsAdditiveCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall47>(value.AnimationClipGetIsAdditive);
            ...
            TextHitTestCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall84>(value.TextHitTest);
            DebugWriteLogCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall85>(value.DebugWriteLog);
            RandomInitializeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall86>(value.RandomInitialize);
            RandomGetValueCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall15>(value.RandomGetValue);
            RandomGetRangeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall87>(value.RandomGetRange);
            ...
            RandomGetInsideUnitSphereCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall88>(value.RandomGetInsideUnitSphere);
            NoiseGetPerlin2DCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall89>(value.NoiseGetPerlin2D);
            LayerMaskGetNameCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall90>(value.LayerMaskGetName);
            LayerMaskGetLayerCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall91>(value.LayerMaskGetLayer);
            SceneGetActiveCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall64>(value.SceneGetActive);
            SceneGetExecutionStateCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall92>(value.SceneGetExecutionState);
            SceneGetLoadedCountCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall20>(value.SceneGetLoadedCount);
            SceneGetLoadedCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall93>(value.SceneGetLoaded);
            SceneLoadCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall94>(value.SceneLoad);
            SceneUnloadCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall95>(value.SceneUnload);
            SceneReloadCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall95>(value.SceneReload);
            SceneSetActiveCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall95>(value.SceneSetActive);
            CameraGetFieldOfViewCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall29>(value.CameraGetFieldOfView);
            CameraSetFieldOfViewCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall30>(value.CameraSetFieldOfView);
            CameraGetProjectionCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall31>(value.CameraGetProjection);
            CameraSetProjectionCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall32>(value.CameraSetProjection);
            CameraGetNearClipPlaneCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall29>(value.CameraGetNearClipPlane);
            CameraSetNearClipPlaneCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall30>(value.CameraSetNearClipPlane);
            CameraGetFarClipPlaneCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall29>(value.CameraGetFarClipPlane);
            CameraSetFarClipPlaneCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall30>(value.CameraSetFarClipPlane);
            CameraGetOrthographicSizeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall29>(value.CameraGetOrthographicSize);
            CameraSetOrthographicSizeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall30>(value.CameraSetOrthographicSize);
            CameraGetAspectRatioCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall29>(value.CameraGetAspectRatio);
            CameraSetAspectRatioCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall30>(value.CameraSetAspectRatio);
            ...
            CameraGetViewportRectangleCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall96>(value.CameraGetViewportRectangle);
            CameraSetViewportRectangleCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall97>(value.CameraSetViewportRectangle);
            CameraGetHdrCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall33>(value.CameraGetHdr);
            CameraSetHdrCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall34>(value.CameraSetHdr);
            CameraGetMsaaCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall33>(value.CameraGetMsaa);
            CameraSetMsaaCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall34>(value.CameraSetMsaa);
            CameraGetOcclusionCullingCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall33>(value.CameraGetOcclusionCulling);
            CameraSetOcclusionCullingCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall34>(value.CameraSetOcclusionCulling);
            CameraGetPrimaryCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall64>(value.CameraGetPrimary);
            CameraGetProjectionMatrixCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall12>(value.CameraGetProjectionMatrix);
            SpriteRendererGetTextureCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall3>(value.SpriteRendererGetTexture);
            SpriteRendererSetTextureCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall42>(value.SpriteRendererSetTexture);
            SpriteRendererGetColorCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall96>(value.SpriteRendererGetColor);
            SpriteRendererSetColorCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall97>(value.SpriteRendererSetColor);
            SpriteRendererGetSortingLayerCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall31>(value.SpriteRendererGetSortingLayer);
            SpriteRendererSetSortingLayerCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall32>(value.SpriteRendererSetSortingLayer);
            SpriteRendererGetOrderInLayerCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall31>(value.SpriteRendererGetOrderInLayer);
            SpriteRendererSetOrderInLayerCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall32>(value.SpriteRendererSetOrderInLayer);
            LightGetTypeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall31>(value.LightGetType);
            LightSetTypeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall32>(value.LightSetType);
            LightGetColorCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall96>(value.LightGetColor);
            LightSetColorCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall97>(value.LightSetColor);
            LightGetIntensityCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall29>(value.LightGetIntensity);
            LightSetIntensityCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall30>(value.LightSetIntensity);
            LightGetRangeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall29>(value.LightGetRange);
            LightSetRangeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall30>(value.LightSetRange);
            LightGetSpotInnerAngleCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall29>(value.LightGetSpotInnerAngle);
            LightSetSpotInnerAngleCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall30>(value.LightSetSpotInnerAngle);
            LightGetSpotOuterAngleCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall29>(value.LightGetSpotOuterAngle);
            LightSetSpotOuterAngleCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall30>(value.LightSetSpotOuterAngle);
            LightGetSourceRadiusCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall29>(value.LightGetSourceRadius);
            LightSetSourceRadiusCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall30>(value.LightSetSourceRadius);
            LightGetUseColorTemperatureCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall33>(value.LightGetUseColorTemperature);
            LightSetUseColorTemperatureCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall34>(value.LightSetUseColorTemperature);
            LightGetTemperatureCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall29>(value.LightGetTemperature);
            LightSetTemperatureCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall30>(value.LightSetTemperature);
            LightGetVisibilityLayersCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall37>(value.LightGetVisibilityLayers);
            LightSetVisibilityLayersCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall38>(value.LightSetVisibilityLayers);
            LightGetEnabledCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall33>(value.LightGetEnabled);
            LightSetEnabledCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall34>(value.LightSetEnabled);
            LightGetAffectDiffuseCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall33>(value.LightGetAffectDiffuse);
            LightSetAffectDiffuseCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall34>(value.LightSetAffectDiffuse);
            LightGetAffectSpecularCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall33>(value.LightGetAffectSpecular);
            LightSetAffectSpecularCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall34>(value.LightSetAffectSpecular);
            LightGetVolumetricCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall33>(value.LightGetVolumetric);
            LightSetVolumetricCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall34>(value.LightSetVolumetric);
            LightGetShadowsCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall31>(value.LightGetShadows);
            LightSetShadowsCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall32>(value.LightSetShadows);
            LightGetShadowBiasCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall29>(value.LightGetShadowBias);
            LightSetShadowBiasCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall30>(value.LightSetShadowBias);
            LightGetShadowNormalBiasCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall29>(value.LightGetShadowNormalBias);
            LightSetShadowNormalBiasCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall30>(value.LightSetShadowNormalBias);
            LightGetShadowNearPlaneCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall29>(value.LightGetShadowNearPlane);
            LightSetShadowNearPlaneCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall30>(value.LightSetShadowNearPlane);
            LightGetShadowImportanceCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall29>(value.LightGetShadowImportance);
            LightSetShadowImportanceCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall30>(value.LightSetShadowImportance);
            LightGetShadowResolutionCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall37>(value.LightGetShadowResolution);
            LightSetShadowResolutionCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall38>(value.LightSetShadowResolution);
            LightGetCacheStaticShadowCastersCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall33>(value.LightGetCacheStaticShadowCasters);
            LightSetCacheStaticShadowCastersCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall34>(value.LightSetCacheStaticShadowCasters);
            Physics2DGetBackendCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall92>(value.Physics2DGetBackend);
            Physics2DGetIsSimulatingCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall18>(value.Physics2DGetIsSimulating);
            Physics2DGetGravityCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall16>(value.Physics2DGetGravity);
            Physics2DSetGravityCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall98>(value.Physics2DSetGravity);
            Physics2DGetVelocityIterationsCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall20>(value.Physics2DGetVelocityIterations);
            Physics2DSetVelocityIterationsCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall99>(value.Physics2DSetVelocityIterations);
            Physics2DGetPositionIterationsCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall20>(value.Physics2DGetPositionIterations);
            Physics2DSetPositionIterationsCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall99>(value.Physics2DSetPositionIterations);
            Physics2DGetDefaultMaterialCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall64>(value.Physics2DGetDefaultMaterial);
            Physics2DSetDefaultMaterialCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall100>(value.Physics2DSetDefaultMaterial);
            Physics2DGetLayerNameCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall90>(value.Physics2DGetLayerName);
            Physics2DSetLayerNameCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall101>(value.Physics2DSetLayerName);
            Physics2DGetLayerMaskCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall102>(value.Physics2DGetLayerMask);
            Physics2DSetLayerMaskCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall103>(value.Physics2DSetLayerMask);
            Physics2DResolveEntityCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall104>(value.Physics2DResolveEntity);
            Physics2DRaycastCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall105>(value.Physics2DRaycast);
            Physics3DGetBackendCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall92>(value.Physics3DGetBackend);
            Physics3DGetBackendNameCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall106>(value.Physics3DGetBackendName);
            Physics3DGetIsSimulatingCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall18>(value.Physics3DGetIsSimulating);
            Physics3DGetCapabilitiesCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall107>(value.Physics3DGetCapabilities);
            Physics3DGetGravityCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall88>(value.Physics3DGetGravity);
            Physics3DSetGravityCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall108>(value.Physics3DSetGravity);
            Physics3DGetSubstepsCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall20>(value.Physics3DGetSubsteps);
            Physics3DSetSubstepsCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall99>(value.Physics3DSetSubsteps);
            Physics3DGetDefaultMaterialCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall64>(value.Physics3DGetDefaultMaterial);
            Physics3DSetDefaultMaterialCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall100>(value.Physics3DSetDefaultMaterial);
            Physics3DTrySetBackendCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall109>(value.Physics3DTrySetBackend);
            Physics3DIsBackendAvailableCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall109>(value.Physics3DIsBackendAvailable);
            Physics3DResolveEntityCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall110>(value.Physics3DResolveEntity);
            Physics3DRaycastCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall111>(value.Physics3DRaycast);
            Physics3DSweepCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall112>(value.Physics3DSweep);
            Physics3DOverlapCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall113>(value.Physics3DOverlap);
            MeshGetVertexCountCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall50>(value.MeshGetVertexCount);
            MeshGetIndexCountCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall50>(value.MeshGetIndexCount);
            MeshCopyVerticesCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall114>(value.MeshCopyVertices);
            MeshSetVerticesCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall115>(value.MeshSetVertices);
            MeshCopyNormalsCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall114>(value.MeshCopyNormals);
            MeshSetNormalsCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall115>(value.MeshSetNormals);
            MeshCopyUvsCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall116>(value.MeshCopyUvs);
            MeshSetUvsCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall117>(value.MeshSetUvs);
            MeshCopyColorsCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall114>(value.MeshCopyColors);
            MeshSetColorsCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall115>(value.MeshSetColors);
            MeshCopyIndicesCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall114>(value.MeshCopyIndices);
            MeshSetIndicesCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall115>(value.MeshSetIndices);
            MeshRecalculateBoundsCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall44>(value.MeshRecalculateBounds);
            MeshRecalculateNormalsCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall44>(value.MeshRecalculateNormals);
            MeshRecalculateTangentsCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall44>(value.MeshRecalculateTangents);
            MeshUploadDataCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall44>(value.MeshUploadData);
            MeshClearCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall44>(value.MeshClear);
            MeshGetBoundsMinCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall118>(value.MeshGetBoundsMin);
            MeshGetBoundsMaxCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall118>(value.MeshGetBoundsMax);
            MeshSetVertexBufferParamsCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall119>(value.MeshSetVertexBufferParams);
            MeshSetVertexBufferDataCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall120>(value.MeshSetVertexBufferData);
            MeshGetVertexBufferDataCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall121>(value.MeshGetVertexBufferData);
            MeshGetVertexStrideCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall50>(value.MeshGetVertexStride);
            MeshGetVertexAttributeCountCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall50>(value.MeshGetVertexAttributeCount);
            MeshHasVertexAttributeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall122>(value.MeshHasVertexAttribute);
            MeshGetVertexAttributeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall123>(value.MeshGetVertexAttribute);
            MeshCreatePlaneCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall124>(value.MeshCreatePlane);
            MeshCreateBoxCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall125>(value.MeshCreateBox);
            MeshCreateCubeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall126>(value.MeshCreateCube);
            MeshCreateSphereCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall127>(value.MeshCreateSphere);
            MeshCreateCylinderCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall128>(value.MeshCreateCylinder);
            MeshCreateConeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall128>(value.MeshCreateCone);
            MeshCreateCapsuleCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall129>(value.MeshCreateCapsule);
            MeshRendererGetMaterialCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall130>(value.MeshRendererGetMaterial);
            MeshRendererSetMaterialCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall131>(value.MeshRendererSetMaterial);
            MathMatrixDeterminantCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall132>(value.MathMatrixDeterminant);
            MathMatrixInverseCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall133>(value.MathMatrixInverse);
            MathMatrixAffineInverseCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall133>(value.MathMatrixAffineInverse);
            MathLookAtCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall134>(value.MathLookAt);
            AddScriptComponentCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall135>(value.AddScriptComponent);
            RemoveScriptComponentCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall135>(value.RemoveScriptComponent);
            MeshRendererGetMeshCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall3>(value.MeshRendererGetMesh);
            MeshRendererSetMeshCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall42>(value.MeshRendererSetMesh);
            MeshRendererGetMaterialCountCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall37>(value.MeshRendererGetMaterialCount);
            MeshRendererSetMaterialCountCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall38>(value.MeshRendererSetMaterialCount);
            Collider2DGetIsTriggerCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall33>(value.Collider2DGetIsTrigger);
            Collider2DSetIsTriggerCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall34>(value.Collider2DSetIsTrigger);
            Collider2DGetOffsetCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall35>(value.Collider2DGetOffset);
            Collider2DSetOffsetCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall36>(value.Collider2DSetOffset);
            Collider2DGetMaterialCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall3>(value.Collider2DGetMaterial);
            Collider2DSetMaterialCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall42>(value.Collider2DSetMaterial);
            BoxCollider2DGetSizeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall35>(value.BoxCollider2DGetSize);
            BoxCollider2DSetSizeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall36>(value.BoxCollider2DSetSize);
            CircleCollider2DGetRadiusCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall29>(value.CircleCollider2DGetRadius);
            CircleCollider2DSetRadiusCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall30>(value.CircleCollider2DSetRadius);
            Collider3DGetIsTriggerCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall33>(value.Collider3DGetIsTrigger);
            Collider3DSetIsTriggerCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall34>(value.Collider3DSetIsTrigger);
            ...
            Collider3DSetMaterialCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall42>(value.Collider3DSetMaterial);
            Collider3DGetCollisionFilterCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall136>(value.Collider3DGetCollisionFilter);
            Collider3DSetCollisionFilterCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall137>(value.Collider3DSetCollisionFilter);
            ...
            SphereCollider3DGetRadiusCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall29>(value.SphereCollider3DGetRadius);
            SphereCollider3DSetRadiusCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall30>(value.SphereCollider3DSetRadius);
            CapsuleCollider3DGetRadiusCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall29>(value.CapsuleCollider3DGetRadius);
            CapsuleCollider3DSetRadiusCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall30>(value.CapsuleCollider3DSetRadius);
            CapsuleCollider3DGetHeightCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall29>(value.CapsuleCollider3DGetHeight);
            CapsuleCollider3DSetHeightCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall30>(value.CapsuleCollider3DSetHeight);
            Rigidbody3DGetBodyTypeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall31>(value.Rigidbody3DGetBodyType);
            Rigidbody3DSetBodyTypeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall32>(value.Rigidbody3DSetBodyType);
            Rigidbody3DGetMassCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall29>(value.Rigidbody3DGetMass);
            Rigidbody3DSetMassCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall30>(value.Rigidbody3DSetMass);
            Rigidbody3DGetAutoMassCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall33>(value.Rigidbody3DGetAutoMass);
            Rigidbody3DSetAutoMassCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall34>(value.Rigidbody3DSetAutoMass);
            Rigidbody3DGetGravityScaleCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall29>(value.Rigidbody3DGetGravityScale);
            Rigidbody3DSetGravityScaleCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall30>(value.Rigidbody3DSetGravityScale);
            Rigidbody3DGetLinearDampingCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall29>(value.Rigidbody3DGetLinearDamping);
            Rigidbody3DSetLinearDampingCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall30>(value.Rigidbody3DSetLinearDamping);
            Rigidbody3DGetAngularDampingCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall29>(value.Rigidbody3DGetAngularDamping);
            Rigidbody3DSetAngularDampingCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall30>(value.Rigidbody3DSetAngularDamping);
            ...
            Rigidbody3DGetAllowSleepCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall33>(value.Rigidbody3DGetAllowSleep);
            Rigidbody3DSetAllowSleepCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall34>(value.Rigidbody3DSetAllowSleep);
            Rigidbody3DGetStartAwakeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall33>(value.Rigidbody3DGetStartAwake);
            Rigidbody3DSetStartAwakeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall34>(value.Rigidbody3DSetStartAwake);
            Rigidbody3DGetContinuousCollisionCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall33>(value.Rigidbody3DGetContinuousCollision);
            Rigidbody3DSetContinuousCollisionCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall34>(value.Rigidbody3DSetContinuousCollision);
            Rigidbody3DGetConstraintsCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall37>(value.Rigidbody3DGetConstraints);
            Rigidbody3DSetConstraintsCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall38>(value.Rigidbody3DSetConstraints);
            Rigidbody3DGetCollisionFilterCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall136>(value.Rigidbody3DGetCollisionFilter);
            Rigidbody3DSetCollisionFilterCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall137>(value.Rigidbody3DSetCollisionFilter);
            ...
            Rigidbody3DGetAwakeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall33>(value.Rigidbody3DGetAwake);
            Rigidbody3DSetAwakeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall34>(value.Rigidbody3DSetAwake);
            Rigidbody3DGetBodyHandleCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall138>(value.Rigidbody3DGetBodyHandle);
            PhysicsMaterial2DGetDensityCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall49>(value.PhysicsMaterial2DGetDensity);
            PhysicsMaterial2DSetDensityCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall139>(value.PhysicsMaterial2DSetDensity);
            PhysicsMaterial2DGetFrictionCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall49>(value.PhysicsMaterial2DGetFriction);
            PhysicsMaterial2DSetFrictionCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall139>(value.PhysicsMaterial2DSetFriction);
            PhysicsMaterial2DGetRestitutionCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall49>(value.PhysicsMaterial2DGetRestitution);
            PhysicsMaterial2DSetRestitutionCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall139>(value.PhysicsMaterial2DSetRestitution);
            PhysicsMaterial2DGetRestitutionThresholdCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall49>(value.PhysicsMaterial2DGetRestitutionThreshold);
            PhysicsMaterial2DSetRestitutionThresholdCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall139>(value.PhysicsMaterial2DSetRestitutionThreshold);
            PhysicsMaterial2DGetFrictionCombineCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall48>(value.PhysicsMaterial2DGetFrictionCombine);
            PhysicsMaterial2DSetFrictionCombineCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall140>(value.PhysicsMaterial2DSetFrictionCombine);
            PhysicsMaterial2DGetRestitutionCombineCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall48>(value.PhysicsMaterial2DGetRestitutionCombine);
            PhysicsMaterial2DSetRestitutionCombineCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall140>(value.PhysicsMaterial2DSetRestitutionCombine);
            PhysicsMaterial3DGetDensityCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall49>(value.PhysicsMaterial3DGetDensity);
            PhysicsMaterial3DSetDensityCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall139>(value.PhysicsMaterial3DSetDensity);
            PhysicsMaterial3DGetFrictionCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall49>(value.PhysicsMaterial3DGetFriction);
            PhysicsMaterial3DSetFrictionCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall139>(value.PhysicsMaterial3DSetFriction);
            PhysicsMaterial3DGetRestitutionCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall49>(value.PhysicsMaterial3DGetRestitution);
            PhysicsMaterial3DSetRestitutionCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall139>(value.PhysicsMaterial3DSetRestitution);
            PhysicsMaterial3DGetRestitutionThresholdCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall49>(value.PhysicsMaterial3DGetRestitutionThreshold);
            PhysicsMaterial3DSetRestitutionThresholdCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall139>(value.PhysicsMaterial3DSetRestitutionThreshold);
            PhysicsMaterial3DGetFrictionCombineCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall48>(value.PhysicsMaterial3DGetFrictionCombine);
            PhysicsMaterial3DSetFrictionCombineCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall140>(value.PhysicsMaterial3DSetFrictionCombine);
            PhysicsMaterial3DGetRestitutionCombineCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall48>(value.PhysicsMaterial3DGetRestitutionCombine);
            PhysicsMaterial3DSetRestitutionCombineCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall140>(value.PhysicsMaterial3DSetRestitutionCombine);
            AnimationComponentGetClipCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall3>(value.AnimationComponentGetClip);
            AnimationComponentSetClipCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall42>(value.AnimationComponentSetClip);
            AnimationComponentGetSpeedCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall29>(value.AnimationComponentGetSpeed);
            AnimationComponentSetSpeedCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall30>(value.AnimationComponentSetSpeed);
            AnimationComponentGetWrapModeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall31>(value.AnimationComponentGetWrapMode);
            AnimationComponentSetWrapModeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall32>(value.AnimationComponentSetWrapMode);
            AnimationComponentGetPlayOnAwakeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall33>(value.AnimationComponentGetPlayOnAwake);
            AnimationComponentSetPlayOnAwakeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall34>(value.AnimationComponentSetPlayOnAwake);
            AnimationComponentGetApplyRootMotionCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall33>(value.AnimationComponentGetApplyRootMotion);
            AnimationComponentSetApplyRootMotionCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall34>(value.AnimationComponentSetApplyRootMotion);
            AnimationComponentGetTimeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall29>(value.AnimationComponentGetTime);
            AnimationComponentSetTimeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall30>(value.AnimationComponentSetTime);
            AnimationComponentGetNormalizedTimeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall29>(value.AnimationComponentGetNormalizedTime);
            AnimationComponentSetNormalizedTimeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall30>(value.AnimationComponentSetNormalizedTime);
            AnimationComponentGetStateCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall31>(value.AnimationComponentGetState);
            TextGetTextCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall0>(value.TextGetText);
            TextSetTextCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall141>(value.TextSetText);
            TextGetFontCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall3>(value.TextGetFont);
            TextSetFontCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall42>(value.TextSetFont);
            TextGetColorCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall96>(value.TextGetColor);
            TextSetColorCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall97>(value.TextSetColor);
            TextGetSizeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall29>(value.TextGetSize);
            TextSetSizeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall30>(value.TextSetSize);
            TextGetAutoSizeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall33>(value.TextGetAutoSize);
            TextSetAutoSizeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall34>(value.TextSetAutoSize);
            TextGetAutoSizeMinCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall29>(value.TextGetAutoSizeMin);
            TextSetAutoSizeMinCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall30>(value.TextSetAutoSizeMin);
            TextGetAutoSizeMaxCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall29>(value.TextGetAutoSizeMax);
            TextSetAutoSizeMaxCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall30>(value.TextSetAutoSizeMax);
            TextGetLayoutSizeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall35>(value.TextGetLayoutSize);
            TextSetLayoutSizeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall36>(value.TextSetLayoutSize);
            TextGetWrappingCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall33>(value.TextGetWrapping);
            TextSetWrappingCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall34>(value.TextSetWrapping);
            TextGetWrapModeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall31>(value.TextGetWrapMode);
            TextSetWrapModeCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall32>(value.TextSetWrapMode);
            TextGetOverflowCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall31>(value.TextGetOverflow);
            TextSetOverflowCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall32>(value.TextSetOverflow);
            TextGetClipToBoundsCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall33>(value.TextGetClipToBounds);
            TextSetClipToBoundsCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall34>(value.TextSetClipToBounds);
            TextGetMaxLinesCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall37>(value.TextGetMaxLines);
            TextSetMaxLinesCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall38>(value.TextSetMaxLines);
            TextGetHorizontalAlignmentCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall31>(value.TextGetHorizontalAlignment);
            TextSetHorizontalAlignmentCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall32>(value.TextSetHorizontalAlignment);
            TextGetVerticalAlignmentCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall31>(value.TextGetVerticalAlignment);
            TextSetVerticalAlignmentCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall32>(value.TextSetVerticalAlignment);
            TextGetFontStyleCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall31>(value.TextGetFontStyle);
            TextSetFontStyleCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall32>(value.TextSetFontStyle);
            TextGetOutlineColorCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall96>(value.TextGetOutlineColor);
            TextSetOutlineColorCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall97>(value.TextSetOutlineColor);
            TextGetOutlineWidthCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall29>(value.TextGetOutlineWidth);
            TextSetOutlineWidthCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall30>(value.TextSetOutlineWidth);
            TextGetShadowColorCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall96>(value.TextGetShadowColor);
            TextSetShadowColorCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall97>(value.TextSetShadowColor);
            TextGetShadowOffsetCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall35>(value.TextGetShadowOffset);
            TextSetShadowOffsetCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall36>(value.TextSetShadowOffset);
            TextGetShadowSoftnessCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall29>(value.TextGetShadowSoftness);
            TextSetShadowSoftnessCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall30>(value.TextSetShadowSoftness);
            TextGetCharacterSpacingCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall29>(value.TextGetCharacterSpacing);
            TextSetCharacterSpacingCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall30>(value.TextSetCharacterSpacing);
            TextGetWordSpacingCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall29>(value.TextGetWordSpacing);
            TextSetWordSpacingCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall30>(value.TextSetWordSpacing);
            TextGetLineSpacingCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall29>(value.TextGetLineSpacing);
            TextSetLineSpacingCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall30>(value.TextSetLineSpacing);
            TextGetParagraphSpacingCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall29>(value.TextGetParagraphSpacing);
            TextSetParagraphSpacingCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall30>(value.TextSetParagraphSpacing);
            TextGetUseCustomDecorationColorCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall33>(value.TextGetUseCustomDecorationColor);
            TextSetUseCustomDecorationColorCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall34>(value.TextSetUseCustomDecorationColor);
            TextGetDecorationColorCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall96>(value.TextGetDecorationColor);
            TextSetDecorationColorCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall97>(value.TextSetDecorationColor);
            TextGetDecorationThicknessCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall29>(value.TextGetDecorationThickness);
            TextSetDecorationThicknessCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall30>(value.TextSetDecorationThickness);
            TextGetUnderlineOffsetCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall29>(value.TextGetUnderlineOffset);
            TextSetUnderlineOffsetCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall30>(value.TextSetUnderlineOffset);
            TextGetStrikethroughOffsetCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall29>(value.TextGetStrikethroughOffset);
            TextSetStrikethroughOffsetCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall30>(value.TextSetStrikethroughOffset);
            TextGetUseKerningCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall33>(value.TextGetUseKerning);
            TextSetUseKerningCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall34>(value.TextSetUseKerning);
            TextGetTabWidthCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall37>(value.TextGetTabWidth);
            TextSetTabWidthCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall38>(value.TextSetTabWidth);
            TextGetSortingLayerCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall31>(value.TextGetSortingLayer);
            TextSetSortingLayerCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall32>(value.TextSetSortingLayer);
            TextGetOrderInLayerCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall31>(value.TextGetOrderInLayer);
            TextSetOrderInLayerCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall32>(value.TextSetOrderInLayer);
            Collider2DGetMaterialOverrideCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall142>(value.Collider2DGetMaterialOverride);
            Collider2DSetMaterialOverrideCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall143>(value.Collider2DSetMaterialOverride);
            Collider3DGetMaterialOverrideCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall142>(value.Collider3DGetMaterialOverride);
            Collider3DSetMaterialOverrideCallback = Marshal.GetDelegateForFunctionPointer<ManagedHostCall143>(value.Collider3DSetMaterialOverride);
            api = value;
        }
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall17(void* context, byte grabbed);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall18(void* context, byte* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall19(void* context, uint type);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall20(void* context, uint* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall21(void* context, uint gamepad, byte* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall22(void* context, uint gamepad, uint code, byte* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall23(void* context, uint gamepad, uint code, float* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall24(void* context, ManagedNativeStringView mapName, byte* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall25(void* context, ManagedNativeStringView actionName, byte* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall26(void* context, ManagedNativeStringView actionName, float* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall27(void* context, ManagedNativeStringView actionName, ManagedNativeVec2* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall28(void* context);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall29(void* context, ManagedNativeUuid entity, float* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall30(void* context, ManagedNativeUuid entity, float value);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall31(void* context, ManagedNativeUuid entity, int* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall32(void* context, ManagedNativeUuid entity, int value);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall33(void* context, ManagedNativeUuid entity, byte* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall34(void* context, ManagedNativeUuid entity, byte value);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall35(void* context, ManagedNativeUuid entity, ManagedNativeVec2* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall36(void* context, ManagedNativeUuid entity, ManagedNativeVec2* value);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall37(void* context, ManagedNativeUuid entity, uint* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall38(void* context, ManagedNativeUuid entity, uint value);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall39(void* context, ManagedNativeUuid entity, ManagedNativeVec2* force, int mode);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall40(void* context, ManagedNativeUuid entity, ManagedNativeVec2* force, ManagedNativeVec2* position, int mode);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall41(void* context, ManagedNativeUuid entity, float torque, int mode);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall42(void* context, ManagedNativeUuid entity, ManagedNativeUuid value);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall43(void* context, ManagedNativeUuid asset, ManagedNativeStringView* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall44(void* context, ManagedNativeUuid asset);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall45(void* context, ManagedNativeStringView path, ManagedNativeUuid* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall46(void* context, ManagedNativeUuid asset, ManagedNativeUuid* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall47(void* context, ManagedNativeUuid asset, byte* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall48(void* context, ManagedNativeUuid asset, int* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall49(void* context, ManagedNativeUuid asset, float* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall50(void* context, ManagedNativeUuid asset, uint* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall51(void* context, ManagedNativeUuid asset, ManagedNativeStringView name, float* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall52(void* context, ManagedNativeUuid asset, ManagedNativeStringView name, float volume);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall53(void* context, ManagedNativeUuid asset, ManagedNativeStringView name, byte* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall54(void* context, ManagedNativeUuid asset, ManagedNativeStringView name, byte muted);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall55(void* context, ManagedNativeUuid asset, ManagedNativeStringView name, float value);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall56(void* context, ManagedNativeUuid asset, ManagedNativeStringView name, ManagedNativeVec2* value);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall57(void* context, ManagedNativeUuid asset, ManagedNativeStringView name, int value);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall58(void* context, ManagedNativeUuid asset, ManagedNativeStringView name, ManagedNativeVec4* value);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall59(void* context, ManagedNativeUuid asset, ManagedNativeStringView name, ManagedNativeVec3* value);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall60(void* context, ManagedNativeUuid asset, ManagedNativeStringView name, ManagedNativeMatrix4* value);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall61(void* context, ManagedNativeUuid asset, ManagedNativeStringView name, ManagedNativeUuid texture);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall62(void* context, ManagedNativeUuid asset, int alphaMode);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall63(void* context, ManagedNativeUuid asset, int preset, byte* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall64(void* context, ManagedNativeUuid* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall65(void* context, ManagedNativeUuid entity, ManagedNativeVec3* force, int mode);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall66(void* context, ManagedNativeUuid entity, ManagedNativeVec3* force, ManagedNativeVec3* position, int mode);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall67(void* context, ManagedNativeUuid entity, ManagedNativeVec3* torque, int mode);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall68(void* context, ManagedNativeMutableBlob destination, ManagedNativeBlob source, int method, int level, ulong* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall69(void* context, ManagedNativeMutableBlob destination, ulong maximumDestinationSize, ManagedNativeBlob source, ulong sourceSize, int method, ulong* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall70(void* context, ManagedNativeStringView title, ManagedNativeStringView directory, ManagedNativeStringView extensions, ManagedNativeStringView* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall71(void* context, ManagedNativeStringView title, ManagedNativeStringView directory, ManagedNativeStringView* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall72(void* context, ManagedNativeStringView title, ManagedNativeStringView directory, ManagedNativeStringView defaultName, ManagedNativeStringView extensions, ManagedNativeStringView* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall73(void* context, ManagedNativeStringView title, ManagedNativeStringView directory, ManagedNativeStringView defaultName, ManagedNativeStringView* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall74(void* context, ManagedNativeUuid asset, uint codePoint, byte* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall75(void* context, ManagedNativeUuid font, byte* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall76(void* context, ManagedNativeUuid font, uint* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall77(void* context, ManagedNativeUuid font, float* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall78(void* context, ManagedNativeUuid font, uint codePoint, byte* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall79(void* context, ManagedNativeUuid font, uint codePoint, byte useFallbacks, ManagedNativeFontCharacterInfo* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall80(void* context, ManagedNativeUuid font, uint index, ManagedNativeUuid* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall81(void* context, ManagedNativeUuid font, ManagedNativeUuid value, byte* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall82(void* context, ManagedNativeUuid font);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall83(void* context, uint index, ManagedNativeStringView* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall84(void* context, ManagedNativeUuid entity, ManagedNativeVec2* position, uint* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall85(void* context, int severity, ManagedNativeStringView message);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall86(void* context, int seed);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall87(void* context, float minimum, float maximum, float* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall88(void* context, ManagedNativeVec3* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall89(void* context, float x, float y, float* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall90(void* context, int layer, ManagedNativeStringView* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall91(void* context, ManagedNativeStringView name, int* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall92(void* context, int* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall93(void* context, uint index, ManagedNativeUuid* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall94(void* context, ManagedNativeUuid scene, byte makeActive, int* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall95(void* context, ManagedNativeUuid scene, int* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall96(void* context, ManagedNativeUuid entity, ManagedNativeVec4* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall97(void* context, ManagedNativeUuid entity, ManagedNativeVec4* value);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall98(void* context, ManagedNativeVec2* value);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall99(void* context, uint value);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall100(void* context, ManagedNativeUuid material);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall101(void* context, int layer, ManagedNativeStringView name);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall102(void* context, int layer, uint* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall103(void* context, int layer, uint mask);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall104(void* context, uint runtimeId, ManagedNativeUuid* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall105(void* context, ManagedNativeVec2* origin, ManagedNativeVec2* direction, float distance, uint layerMask, void* destination, uint capacity, uint* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall106(void* context, ManagedNativeStringView* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall107(void* context, ulong* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall108(void* context, ManagedNativeVec3* value);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall109(void* context, int value, byte* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall110(void* context, ulong runtimeId, ManagedNativeUuid* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall111(void* context, ManagedNativeVec3* origin, ManagedNativeVec3* direction, float distance, uint layerMask, byte includeTriggers, ulong ignoreBodyHandle, void* destination, uint capacity, uint* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall112(void* context, int shapeType, ManagedNativeVec3* size, float radius, float height, ManagedNativeVec3* position, ManagedNativeQuaternion* rotation, ManagedNativeVec3* direction, float distance, uint layerMask, byte includeTriggers, ulong ignoreBodyHandle, void* destination, uint capacity, uint* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall113(void* context, int shapeType, ManagedNativeVec3* size, float radius, float height, ManagedNativeVec3* position, ManagedNativeQuaternion* rotation, uint layerMask, byte includeTriggers, ulong ignoreBodyHandle, void* destination, uint capacity, uint* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall114(void* context, ManagedNativeUuid asset, void* destination, uint capacity, uint* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall115(void* context, ManagedNativeUuid asset, void* source, uint count);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall116(void* context, ManagedNativeUuid asset, uint channel, void* destination, uint capacity, uint* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall117(void* context, ManagedNativeUuid asset, uint channel, void* source, uint count);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall118(void* context, ManagedNativeUuid asset, ManagedNativeVec3* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall119(void* context, ManagedNativeUuid asset, uint vertexCount, void* layout, uint layoutCount);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall120(void* context, ManagedNativeUuid asset, void* source, uint meshBufferStart, uint count, uint stride);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall121(void* context, ManagedNativeUuid asset, void* destination, uint capacity, uint stride, uint* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall122(void* context, ManagedNativeUuid asset, int attribute, byte* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall123(void* context, ManagedNativeUuid asset, int index, void* destination);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall124(void* context, float width, float height, uint subdivisionsX, uint subdivisionsY, ManagedNativeUuid* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall125(void* context, ManagedNativeVec3* dimensions, ManagedNativeUuid* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall126(void* context, float size, ManagedNativeUuid* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall127(void* context, float radius, uint segments, uint rings, ManagedNativeUuid* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall128(void* context, float radius, float height, uint segments, byte capped, ManagedNativeUuid* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall129(void* context, float radius, float height, uint segments, uint hemisphereRings, ManagedNativeUuid* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall130(void* context, ManagedNativeUuid entity, uint index, ManagedNativeUuid* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall131(void* context, ManagedNativeUuid entity, uint index, ManagedNativeUuid material);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall132(void* context, ManagedNativeMatrix4* matrix, float* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall133(void* context, ManagedNativeMatrix4* matrix, ManagedNativeMatrix4* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall134(void* context, ManagedNativeVec3* from, ManagedNativeVec3* to, ManagedNativeVec3* up, ManagedNativeMatrix4* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall135(void* context, ManagedNativeUuid entity, ManagedNativeStringView assemblyName, ManagedNativeStringView namespaceName, ManagedNativeStringView typeName);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall136(void* context, ManagedNativeUuid entity, ManagedNativePhysicsFilter3D* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall137(void* context, ManagedNativeUuid entity, ManagedNativePhysicsFilter3D* value);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall138(void* context, ManagedNativeUuid entity, ulong* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall139(void* context, ManagedNativeUuid asset, float value);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall140(void* context, ManagedNativeUuid asset, int value);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall141(void* context, ManagedNativeUuid entity, ManagedNativeStringView value);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall142(void* context, ManagedNativeUuid entity, ManagedNativePhysicsMaterialOverride* result);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int ManagedHostCall143(void* context, ManagedNativeUuid entity, ManagedNativePhysicsMaterialOverride* value);
        ...
        private static ManagedHostCall17 InputSetMouseGrabbedCallback;
        private static ManagedHostCall18 InputIsMouseGrabbedCallback;
        private static ManagedHostCall19 InputSetCursorTypeCallback;
        private static ManagedHostCall20 InputGetCursorTypeCallback;
        private static ManagedHostCall21 InputIsGamepadConnectedCallback;
        private static ManagedHostCall22 InputGetGamepadButtonCallback;
        private static ManagedHostCall22 InputGetGamepadButtonDownCallback;
        private static ManagedHostCall22 InputGetGamepadButtonUpCallback;
        private static ManagedHostCall23 InputGetGamepadAxisCallback;
        private static ManagedHostCall24 InputEnableActionMapCallback;
        private static ManagedHostCall24 InputDisableActionMapCallback;
        private static ManagedHostCall25 InputGetActionCallback;
        private static ManagedHostCall25 InputGetActionDownCallback;
        private static ManagedHostCall25 InputGetActionUpCallback;
        private static ManagedHostCall26 InputGetAxisCallback;
        private static ManagedHostCall27 InputGetActionVectorCallback;
        private static ManagedHostCall28 InputClearActionRebindsCallback;
        ...
        private static ManagedHostCall20 TimeGetFrameCountCallback;
        private static ManagedHostCall16 ScreenGetSizeCallback;
        private static ManagedHostCall29 Rigidbody2DGetMassCallback;
        private static ManagedHostCall30 Rigidbody2DSetMassCallback;
        private static ManagedHostCall31 Rigidbody2DGetBodyTypeCallback;
        private static ManagedHostCall32 Rigidbody2DSetBodyTypeCallback;
        private static ManagedHostCall31 Rigidbody2DGetSleepModeCallback;
        private static ManagedHostCall32 Rigidbody2DSetSleepModeCallback;
        private static ManagedHostCall31 Rigidbody2DGetCollisionDetectionModeCallback;
        private static ManagedHostCall32 Rigidbody2DSetCollisionDetectionModeCallback;
        private static ManagedHostCall31 Rigidbody2DGetInterpolationCallback;
        private static ManagedHostCall32 Rigidbody2DSetInterpolationCallback;
        private static ManagedHostCall33 Rigidbody2DGetAutoMassCallback;
        private static ManagedHostCall34 Rigidbody2DSetAutoMassCallback;
        private static ManagedHostCall31 Rigidbody2DGetLayerCallback;
        private static ManagedHostCall32 Rigidbody2DSetLayerCallback;
        private static ManagedHostCall29 Rigidbody2DGetLinearDragCallback;
        private static ManagedHostCall30 Rigidbody2DSetLinearDragCallback;
        private static ManagedHostCall29 Rigidbody2DGetAngularDragCallback;
        private static ManagedHostCall30 Rigidbody2DSetAngularDragCallback;
        private static ManagedHostCall29 Rigidbody2DGetGravityScaleCallback;
        private static ManagedHostCall30 Rigidbody2DSetGravityScaleCallback;
        private static ManagedHostCall35 Rigidbody2DGetCenterOfMassCallback;
        private static ManagedHostCall36 Rigidbody2DSetCenterOfMassCallback;
        private static ManagedHostCall29 Rigidbody2DGetInertiaCallback;
        private static ManagedHostCall30 Rigidbody2DSetInertiaCallback;
        private static ManagedHostCall37 Rigidbody2DGetConstraintsCallback;
        private static ManagedHostCall38 Rigidbody2DSetConstraintsCallback;
        private static ManagedHostCall29 Rigidbody2DGetRotationCallback;
        private static ManagedHostCall35 Rigidbody2DGetPositionCallback;
        private static ManagedHostCall35 Rigidbody2DGetLinearVelocityCallback;
        private static ManagedHostCall36 Rigidbody2DSetLinearVelocityCallback;
        private static ManagedHostCall29 Rigidbody2DGetAngularVelocityCallback;
        private static ManagedHostCall30 Rigidbody2DSetAngularVelocityCallback;
        private static ManagedHostCall33 Rigidbody2DGetAwakeCallback;
        private static ManagedHostCall34 Rigidbody2DSetAwakeCallback;
        private static ManagedHostCall39 Rigidbody2DAddForceCallback;
        private static ManagedHostCall40 Rigidbody2DAddForceAtPositionCallback;
        private static ManagedHostCall41 Rigidbody2DAddTorqueCallback;
        private static ManagedHostCall29 AudioSourceGetVolumeCallback;
        private static ManagedHostCall30 AudioSourceSetVolumeCallback;
        private static ManagedHostCall29 AudioSourceGetPitchCallback;
        private static ManagedHostCall30 AudioSourceSetPitchCallback;
        private static ManagedHostCall29 AudioSourceGetMinDistanceCallback;
        private static ManagedHostCall30 AudioSourceSetMinDistanceCallback;
        private static ManagedHostCall29 AudioSourceGetMaxDistanceCallback;
        private static ManagedHostCall30 AudioSourceSetMaxDistanceCallback;
        private static ManagedHostCall33 AudioSourceGetLoopCallback;
        private static ManagedHostCall34 AudioSourceSetLoopCallback;
        private static ManagedHostCall33 AudioSourceGetMutedCallback;
        private static ManagedHostCall34 AudioSourceSetMutedCallback;
        private static ManagedHostCall33 AudioSourceGetPlayOnAwakeCallback;
        private static ManagedHostCall34 AudioSourceSetPlayOnAwakeCallback;
        private static ManagedHostCall29 AudioSourceGetTimeCallback;
        private static ManagedHostCall30 AudioSourceSetTimeCallback;
        private static ManagedHostCall3 AudioSourceGetClipCallback;
        private static ManagedHostCall42 AudioSourceSetClipCallback;
        private static ManagedHostCall31 AudioSourceGetStateCallback;
        ...
        private static ManagedHostCall43 AssetGetNameCallback;
        private static ManagedHostCall44 AssetAcquireCallback;
        private static ManagedHostCall44 AssetReleaseCallback;
        private static ManagedHostCall45 AssetDatabaseLoadCallback;
        private static ManagedHostCall46 AssetDatabaseLoadFromUuidCallback;
        private static ManagedHostCall43 AssetDatabaseGetPathCallback;
        private static ManagedHostCall47 AssetDatabaseIsValidCallback;
        private static ManagedHostCall48 AudioClipGetBitDepthCallback;
        private static ManagedHostCall48 AudioClipGetChannelsCallback;
        private static ManagedHostCall48 AudioClipGetFrequencyCallback;
        private static ManagedHostCall48 AudioClipGetSamplesCallback;
        private static ManagedHostCall49 AudioClipGetLengthCallback;
        private static ManagedHostCall48 AudioClipGetReadModeCallback;
        private static ManagedHostCall48 AudioClipGetFormatCallback;
        private static ManagedHostCall47 AudioClipGetIs3DCallback;
        private static ManagedHostCall50 TextureGetWidthCallback;
        private static ManagedHostCall50 TextureGetHeightCallback;
        private static ManagedHostCall44 AudioMixerSetActiveCallback;
        private static ManagedHostCall51 AudioMixerGetBusVolumeCallback;
        private static ManagedHostCall52 AudioMixerSetBusVolumeCallback;
        private static ManagedHostCall53 AudioMixerIsBusMutedCallback;
        private static ManagedHostCall54 AudioMixerSetBusMutedCallback;
        private static ManagedHostCall55 MaterialSetFloatCallback;
        private static ManagedHostCall56 MaterialSetVector2Callback;
        private static ManagedHostCall57 MaterialSetIntCallback;
        private static ManagedHostCall58 MaterialSetColorCallback;
        private static ManagedHostCall59 MaterialSetVector3Callback;
        private static ManagedHostCall60 MaterialSetMatrixCallback;
        private static ManagedHostCall61 MaterialSetTextureCallback;
        private static ManagedHostCall47 MaterialHasAlphaModeOverrideCallback;
        private static ManagedHostCall48 MaterialGetAlphaModeCallback;
        private static ManagedHostCall62 MaterialSetAlphaModeCallback;
        private static ManagedHostCall44 MaterialClearAlphaModeOverrideCallback;
        private static ManagedHostCall63 MaterialApplyToonPresetCallback;
        private static ManagedHostCall64 PhysicsMaterial2DCreateCallback;
        private static ManagedHostCall64 PhysicsMaterial3DCreateCallback;
        private static ManagedHostCall65 Rigidbody3DAddForceCallback;
        private static ManagedHostCall66 Rigidbody3DAddForceAtCallback;
        private static ManagedHostCall67 Rigidbody3DAddTorqueCallback;
        private static ManagedHostCall68 CompressionCompressCallback;
        private static ManagedHostCall69 CompressionDecompressCallback;
        private static ManagedHostCall70 FileDialogOpenFileCallback;
        private static ManagedHostCall71 FileDialogOpenFolderCallback;
        private static ManagedHostCall72 FileDialogSaveFileCallback;
        private static ManagedHostCall73 FileDialogSaveFolderCallback;
        private static ManagedHostCall74 FontHasCharacterCallback;
        private static ManagedHostCall75 FontGetIsValidCallback;
        private static ManagedHostCall76 FontGetGlyphCountCallback;
        private static ManagedHostCall76 FontGetTabWidthCallback;
        private static ManagedHostCall76 FontGetAtlasWidthCallback;
        private static ManagedHostCall76 FontGetAtlasHeightCallback;
        private static ManagedHostCall77 FontGetAtlasPixelRangeCallback;
        private static ManagedHostCall76 FontGetFallbackCountCallback;
        private static ManagedHostCall78 FontHasGlyphCallback;
        private static ManagedHostCall79 FontGetCharacterInfoCallback;
        private static ManagedHostCall80 FontGetFallbackCallback;
        private static ManagedHostCall81 FontAddFallbackCallback;
        private static ManagedHostCall82 FontClearFallbacksCallback;
        private static ManagedHostCall20 FontGetSystemFontCountCallback;
        private static ManagedHostCall83 FontGetSystemFontPathCallback;
        private static ManagedHostCall83 FontGetSystemFontNameCallback;
        private static ManagedHostCall49 AnimationClipGetLengthCallback;
        private static ManagedHostCall49 AnimationClipGetSampleRateCallback;
        private static ManagedHostCall47 AnimationClipGetIsAdditiveCallback;
        ...
        private static ManagedHostCall84 TextHitTestCallback;
        private static ManagedHostCall85 DebugWriteLogCallback;
        private static ManagedHostCall86 RandomInitializeCallback;
        private static ManagedHostCall15 RandomGetValueCallback;
        private static ManagedHostCall87 RandomGetRangeCallback;
        private static ManagedHostCall16 RandomGetInsideUnitCircleCallback;
        private static ManagedHostCall88 RandomGetInsideUnitSphereCallback;
        private static ManagedHostCall89 NoiseGetPerlin2DCallback;
        private static ManagedHostCall90 LayerMaskGetNameCallback;
        private static ManagedHostCall91 LayerMaskGetLayerCallback;
        private static ManagedHostCall64 SceneGetActiveCallback;
        private static ManagedHostCall92 SceneGetExecutionStateCallback;
        private static ManagedHostCall20 SceneGetLoadedCountCallback;
        private static ManagedHostCall93 SceneGetLoadedCallback;
        private static ManagedHostCall94 SceneLoadCallback;
        private static ManagedHostCall95 SceneUnloadCallback;
        private static ManagedHostCall95 SceneReloadCallback;
        private static ManagedHostCall95 SceneSetActiveCallback;
        private static ManagedHostCall29 CameraGetFieldOfViewCallback;
        private static ManagedHostCall30 CameraSetFieldOfViewCallback;
        private static ManagedHostCall31 CameraGetProjectionCallback;
        private static ManagedHostCall32 CameraSetProjectionCallback;
        private static ManagedHostCall29 CameraGetNearClipPlaneCallback;
        private static ManagedHostCall30 CameraSetNearClipPlaneCallback;
        private static ManagedHostCall29 CameraGetFarClipPlaneCallback;
        private static ManagedHostCall30 CameraSetFarClipPlaneCallback;
        private static ManagedHostCall29 CameraGetOrthographicSizeCallback;
        private static ManagedHostCall30 CameraSetOrthographicSizeCallback;
        private static ManagedHostCall29 CameraGetAspectRatioCallback;
        private static ManagedHostCall30 CameraSetAspectRatioCallback;
        ...
        private static ManagedHostCall96 CameraGetViewportRectangleCallback;
        private static ManagedHostCall97 CameraSetViewportRectangleCallback;
        private static ManagedHostCall33 CameraGetHdrCallback;
        private static ManagedHostCall34 CameraSetHdrCallback;
        private static ManagedHostCall33 CameraGetMsaaCallback;
        private static ManagedHostCall34 CameraSetMsaaCallback;
        private static ManagedHostCall33 CameraGetOcclusionCullingCallback;
        private static ManagedHostCall34 CameraSetOcclusionCullingCallback;
        private static ManagedHostCall64 CameraGetPrimaryCallback;
        private static ManagedHostCall12 CameraGetProjectionMatrixCallback;
        private static ManagedHostCall3 SpriteRendererGetTextureCallback;
        private static ManagedHostCall42 SpriteRendererSetTextureCallback;
        private static ManagedHostCall96 SpriteRendererGetColorCallback;
        private static ManagedHostCall97 SpriteRendererSetColorCallback;
        private static ManagedHostCall31 SpriteRendererGetSortingLayerCallback;
        private static ManagedHostCall32 SpriteRendererSetSortingLayerCallback;
        private static ManagedHostCall31 SpriteRendererGetOrderInLayerCallback;
        private static ManagedHostCall32 SpriteRendererSetOrderInLayerCallback;
        private static ManagedHostCall31 LightGetTypeCallback;
        private static ManagedHostCall32 LightSetTypeCallback;
        private static ManagedHostCall96 LightGetColorCallback;
        private static ManagedHostCall97 LightSetColorCallback;
        private static ManagedHostCall29 LightGetIntensityCallback;
        private static ManagedHostCall30 LightSetIntensityCallback;
        private static ManagedHostCall29 LightGetRangeCallback;
        private static ManagedHostCall30 LightSetRangeCallback;
        private static ManagedHostCall29 LightGetSpotInnerAngleCallback;
        private static ManagedHostCall30 LightSetSpotInnerAngleCallback;
        private static ManagedHostCall29 LightGetSpotOuterAngleCallback;
        private static ManagedHostCall30 LightSetSpotOuterAngleCallback;
        private static ManagedHostCall29 LightGetSourceRadiusCallback;
        private static ManagedHostCall30 LightSetSourceRadiusCallback;
        private static ManagedHostCall33 LightGetUseColorTemperatureCallback;
        private static ManagedHostCall34 LightSetUseColorTemperatureCallback;
        private static ManagedHostCall29 LightGetTemperatureCallback;
        private static ManagedHostCall30 LightSetTemperatureCallback;
        private static ManagedHostCall37 LightGetVisibilityLayersCallback;
        private static ManagedHostCall38 LightSetVisibilityLayersCallback;
        private static ManagedHostCall33 LightGetEnabledCallback;
        private static ManagedHostCall34 LightSetEnabledCallback;
        private static ManagedHostCall33 LightGetAffectDiffuseCallback;
        private static ManagedHostCall34 LightSetAffectDiffuseCallback;
        private static ManagedHostCall33 LightGetAffectSpecularCallback;
        private static ManagedHostCall34 LightSetAffectSpecularCallback;
        private static ManagedHostCall33 LightGetVolumetricCallback;
        private static ManagedHostCall34 LightSetVolumetricCallback;
        private static ManagedHostCall31 LightGetShadowsCallback;
        private static ManagedHostCall32 LightSetShadowsCallback;
        private static ManagedHostCall29 LightGetShadowBiasCallback;
        private static ManagedHostCall30 LightSetShadowBiasCallback;
        private static ManagedHostCall29 LightGetShadowNormalBiasCallback;
        private static ManagedHostCall30 LightSetShadowNormalBiasCallback;
        private static ManagedHostCall29 LightGetShadowNearPlaneCallback;
        private static ManagedHostCall30 LightSetShadowNearPlaneCallback;
        private static ManagedHostCall29 LightGetShadowImportanceCallback;
        private static ManagedHostCall30 LightSetShadowImportanceCallback;
        private static ManagedHostCall37 LightGetShadowResolutionCallback;
        private static ManagedHostCall38 LightSetShadowResolutionCallback;
        private static ManagedHostCall33 LightGetCacheStaticShadowCastersCallback;
        private static ManagedHostCall34 LightSetCacheStaticShadowCastersCallback;
        private static ManagedHostCall92 Physics2DGetBackendCallback;
        private static ManagedHostCall18 Physics2DGetIsSimulatingCallback;
        private static ManagedHostCall16 Physics2DGetGravityCallback;
        private static ManagedHostCall98 Physics2DSetGravityCallback;
        private static ManagedHostCall20 Physics2DGetVelocityIterationsCallback;
        private static ManagedHostCall99 Physics2DSetVelocityIterationsCallback;
        private static ManagedHostCall20 Physics2DGetPositionIterationsCallback;
        private static ManagedHostCall99 Physics2DSetPositionIterationsCallback;
        private static ManagedHostCall64 Physics2DGetDefaultMaterialCallback;
        private static ManagedHostCall100 Physics2DSetDefaultMaterialCallback;
        private static ManagedHostCall90 Physics2DGetLayerNameCallback;
        private static ManagedHostCall101 Physics2DSetLayerNameCallback;
        private static ManagedHostCall102 Physics2DGetLayerMaskCallback;
        private static ManagedHostCall103 Physics2DSetLayerMaskCallback;
        private static ManagedHostCall104 Physics2DResolveEntityCallback;
        private static ManagedHostCall105 Physics2DRaycastCallback;
        private static ManagedHostCall92 Physics3DGetBackendCallback;
        private static ManagedHostCall106 Physics3DGetBackendNameCallback;
        private static ManagedHostCall18 Physics3DGetIsSimulatingCallback;
        private static ManagedHostCall107 Physics3DGetCapabilitiesCallback;
        private static ManagedHostCall88 Physics3DGetGravityCallback;
        private static ManagedHostCall108 Physics3DSetGravityCallback;
        private static ManagedHostCall20 Physics3DGetSubstepsCallback;
        private static ManagedHostCall99 Physics3DSetSubstepsCallback;
        private static ManagedHostCall64 Physics3DGetDefaultMaterialCallback;
        private static ManagedHostCall100 Physics3DSetDefaultMaterialCallback;
        private static ManagedHostCall109 Physics3DTrySetBackendCallback;
        private static ManagedHostCall109 Physics3DIsBackendAvailableCallback;
        private static ManagedHostCall110 Physics3DResolveEntityCallback;
        private static ManagedHostCall111 Physics3DRaycastCallback;
        private static ManagedHostCall112 Physics3DSweepCallback;
        private static ManagedHostCall113 Physics3DOverlapCallback;
        private static ManagedHostCall50 MeshGetVertexCountCallback;
        private static ManagedHostCall50 MeshGetIndexCountCallback;
        private static ManagedHostCall114 MeshCopyVerticesCallback;
        private static ManagedHostCall115 MeshSetVerticesCallback;
        private static ManagedHostCall114 MeshCopyNormalsCallback;
        private static ManagedHostCall115 MeshSetNormalsCallback;
        private static ManagedHostCall116 MeshCopyUvsCallback;
        private static ManagedHostCall117 MeshSetUvsCallback;
        private static ManagedHostCall114 MeshCopyColorsCallback;
        private static ManagedHostCall115 MeshSetColorsCallback;
        private static ManagedHostCall114 MeshCopyIndicesCallback;
        private static ManagedHostCall115 MeshSetIndicesCallback;
        private static ManagedHostCall44 MeshRecalculateBoundsCallback;
        private static ManagedHostCall44 MeshRecalculateNormalsCallback;
        private static ManagedHostCall44 MeshRecalculateTangentsCallback;
        private static ManagedHostCall44 MeshUploadDataCallback;
        private static ManagedHostCall44 MeshClearCallback;
        private static ManagedHostCall118 MeshGetBoundsMinCallback;
        private static ManagedHostCall118 MeshGetBoundsMaxCallback;
        private static ManagedHostCall119 MeshSetVertexBufferParamsCallback;
        private static ManagedHostCall120 MeshSetVertexBufferDataCallback;
        private static ManagedHostCall121 MeshGetVertexBufferDataCallback;
        private static ManagedHostCall50 MeshGetVertexStrideCallback;
        private static ManagedHostCall50 MeshGetVertexAttributeCountCallback;
        private static ManagedHostCall122 MeshHasVertexAttributeCallback;
        private static ManagedHostCall123 MeshGetVertexAttributeCallback;
        private static ManagedHostCall124 MeshCreatePlaneCallback;
        private static ManagedHostCall125 MeshCreateBoxCallback;
        private static ManagedHostCall126 MeshCreateCubeCallback;
        private static ManagedHostCall127 MeshCreateSphereCallback;
        private static ManagedHostCall128 MeshCreateCylinderCallback;
        private static ManagedHostCall128 MeshCreateConeCallback;
        private static ManagedHostCall129 MeshCreateCapsuleCallback;
        private static ManagedHostCall130 MeshRendererGetMaterialCallback;
        private static ManagedHostCall131 MeshRendererSetMaterialCallback;
        private static ManagedHostCall132 MathMatrixDeterminantCallback;
        private static ManagedHostCall133 MathMatrixInverseCallback;
        private static ManagedHostCall133 MathMatrixAffineInverseCallback;
        private static ManagedHostCall134 MathLookAtCallback;
        private static ManagedHostCall135 AddScriptComponentCallback;
        private static ManagedHostCall135 RemoveScriptComponentCallback;
        private static ManagedHostCall3 MeshRendererGetMeshCallback;
        private static ManagedHostCall42 MeshRendererSetMeshCallback;
        private static ManagedHostCall37 MeshRendererGetMaterialCountCallback;
        private static ManagedHostCall38 MeshRendererSetMaterialCountCallback;
        private static ManagedHostCall33 Collider2DGetIsTriggerCallback;
        private static ManagedHostCall34 Collider2DSetIsTriggerCallback;
        private static ManagedHostCall35 Collider2DGetOffsetCallback;
        private static ManagedHostCall36 Collider2DSetOffsetCallback;
        private static ManagedHostCall3 Collider2DGetMaterialCallback;
        private static ManagedHostCall42 Collider2DSetMaterialCallback;
        private static ManagedHostCall35 BoxCollider2DGetSizeCallback;
        private static ManagedHostCall36 BoxCollider2DSetSizeCallback;
        private static ManagedHostCall29 CircleCollider2DGetRadiusCallback;
        private static ManagedHostCall30 CircleCollider2DSetRadiusCallback;
        private static ManagedHostCall33 Collider3DGetIsTriggerCallback;
        private static ManagedHostCall34 Collider3DSetIsTriggerCallback;
        ...
        private static ManagedHostCall42 Collider3DSetMaterialCallback;
        private static ManagedHostCall136 Collider3DGetCollisionFilterCallback;
        private static ManagedHostCall137 Collider3DSetCollisionFilterCallback;
        private static ManagedHostCall8 BoxCollider3DGetSizeCallback;
        private static ManagedHostCall9 BoxCollider3DSetSizeCallback;
        private static ManagedHostCall29 SphereCollider3DGetRadiusCallback;
        private static ManagedHostCall30 SphereCollider3DSetRadiusCallback;
        private static ManagedHostCall29 CapsuleCollider3DGetRadiusCallback;
        private static ManagedHostCall30 CapsuleCollider3DSetRadiusCallback;
        private static ManagedHostCall29 CapsuleCollider3DGetHeightCallback;
        private static ManagedHostCall30 CapsuleCollider3DSetHeightCallback;
        private static ManagedHostCall31 Rigidbody3DGetBodyTypeCallback;
        private static ManagedHostCall32 Rigidbody3DSetBodyTypeCallback;
        private static ManagedHostCall29 Rigidbody3DGetMassCallback;
        private static ManagedHostCall30 Rigidbody3DSetMassCallback;
        private static ManagedHostCall33 Rigidbody3DGetAutoMassCallback;
        private static ManagedHostCall34 Rigidbody3DSetAutoMassCallback;
        private static ManagedHostCall29 Rigidbody3DGetGravityScaleCallback;
        private static ManagedHostCall30 Rigidbody3DSetGravityScaleCallback;
        private static ManagedHostCall29 Rigidbody3DGetLinearDampingCallback;
        private static ManagedHostCall30 Rigidbody3DSetLinearDampingCallback;
        private static ManagedHostCall29 Rigidbody3DGetAngularDampingCallback;
        private static ManagedHostCall30 Rigidbody3DSetAngularDampingCallback;
        ...
        private static ManagedHostCall33 Rigidbody3DGetAllowSleepCallback;
        private static ManagedHostCall34 Rigidbody3DSetAllowSleepCallback;
        private static ManagedHostCall33 Rigidbody3DGetStartAwakeCallback;
        private static ManagedHostCall34 Rigidbody3DSetStartAwakeCallback;
        private static ManagedHostCall33 Rigidbody3DGetContinuousCollisionCallback;
        private static ManagedHostCall34 Rigidbody3DSetContinuousCollisionCallback;
        private static ManagedHostCall37 Rigidbody3DGetConstraintsCallback;
        private static ManagedHostCall38 Rigidbody3DSetConstraintsCallback;
        private static ManagedHostCall136 Rigidbody3DGetCollisionFilterCallback;
        private static ManagedHostCall137 Rigidbody3DSetCollisionFilterCallback;
        ...
        private static ManagedHostCall33 Rigidbody3DGetAwakeCallback;
        private static ManagedHostCall34 Rigidbody3DSetAwakeCallback;
        private static ManagedHostCall138 Rigidbody3DGetBodyHandleCallback;
        private static ManagedHostCall49 PhysicsMaterial2DGetDensityCallback;
        private static ManagedHostCall139 PhysicsMaterial2DSetDensityCallback;
        private static ManagedHostCall49 PhysicsMaterial2DGetFrictionCallback;
        private static ManagedHostCall139 PhysicsMaterial2DSetFrictionCallback;
        private static ManagedHostCall49 PhysicsMaterial2DGetRestitutionCallback;
        private static ManagedHostCall139 PhysicsMaterial2DSetRestitutionCallback;
        private static ManagedHostCall49 PhysicsMaterial2DGetRestitutionThresholdCallback;
        private static ManagedHostCall139 PhysicsMaterial2DSetRestitutionThresholdCallback;
        private static ManagedHostCall48 PhysicsMaterial2DGetFrictionCombineCallback;
        private static ManagedHostCall140 PhysicsMaterial2DSetFrictionCombineCallback;
        private static ManagedHostCall48 PhysicsMaterial2DGetRestitutionCombineCallback;
        private static ManagedHostCall140 PhysicsMaterial2DSetRestitutionCombineCallback;
        private static ManagedHostCall49 PhysicsMaterial3DGetDensityCallback;
        private static ManagedHostCall139 PhysicsMaterial3DSetDensityCallback;
        private static ManagedHostCall49 PhysicsMaterial3DGetFrictionCallback;
        private static ManagedHostCall139 PhysicsMaterial3DSetFrictionCallback;
        private static ManagedHostCall49 PhysicsMaterial3DGetRestitutionCallback;
        private static ManagedHostCall139 PhysicsMaterial3DSetRestitutionCallback;
        private static ManagedHostCall49 PhysicsMaterial3DGetRestitutionThresholdCallback;
        private static ManagedHostCall139 PhysicsMaterial3DSetRestitutionThresholdCallback;
        private static ManagedHostCall48 PhysicsMaterial3DGetFrictionCombineCallback;
        private static ManagedHostCall140 PhysicsMaterial3DSetFrictionCombineCallback;
        private static ManagedHostCall48 PhysicsMaterial3DGetRestitutionCombineCallback;
        private static ManagedHostCall140 PhysicsMaterial3DSetRestitutionCombineCallback;
        private static ManagedHostCall3 AnimationComponentGetClipCallback;
        private static ManagedHostCall42 AnimationComponentSetClipCallback;
        private static ManagedHostCall29 AnimationComponentGetSpeedCallback;
        private static ManagedHostCall30 AnimationComponentSetSpeedCallback;
        private static ManagedHostCall31 AnimationComponentGetWrapModeCallback;
        private static ManagedHostCall32 AnimationComponentSetWrapModeCallback;
        private static ManagedHostCall33 AnimationComponentGetPlayOnAwakeCallback;
        private static ManagedHostCall34 AnimationComponentSetPlayOnAwakeCallback;
        private static ManagedHostCall33 AnimationComponentGetApplyRootMotionCallback;
        private static ManagedHostCall34 AnimationComponentSetApplyRootMotionCallback;
        private static ManagedHostCall29 AnimationComponentGetTimeCallback;
        private static ManagedHostCall30 AnimationComponentSetTimeCallback;
        private static ManagedHostCall29 AnimationComponentGetNormalizedTimeCallback;
        private static ManagedHostCall30 AnimationComponentSetNormalizedTimeCallback;
        private static ManagedHostCall31 AnimationComponentGetStateCallback;
        private static ManagedHostCall0 TextGetTextCallback;
        private static ManagedHostCall141 TextSetTextCallback;
        private static ManagedHostCall3 TextGetFontCallback;
        private static ManagedHostCall42 TextSetFontCallback;
        private static ManagedHostCall96 TextGetColorCallback;
        private static ManagedHostCall97 TextSetColorCallback;
        private static ManagedHostCall29 TextGetSizeCallback;
        private static ManagedHostCall30 TextSetSizeCallback;
        private static ManagedHostCall33 TextGetAutoSizeCallback;
        private static ManagedHostCall34 TextSetAutoSizeCallback;
        private static ManagedHostCall29 TextGetAutoSizeMinCallback;
        private static ManagedHostCall30 TextSetAutoSizeMinCallback;
        private static ManagedHostCall29 TextGetAutoSizeMaxCallback;
        private static ManagedHostCall30 TextSetAutoSizeMaxCallback;
        private static ManagedHostCall35 TextGetLayoutSizeCallback;
        private static ManagedHostCall36 TextSetLayoutSizeCallback;
        private static ManagedHostCall33 TextGetWrappingCallback;
        private static ManagedHostCall34 TextSetWrappingCallback;
        private static ManagedHostCall31 TextGetWrapModeCallback;
        private static ManagedHostCall32 TextSetWrapModeCallback;
        private static ManagedHostCall31 TextGetOverflowCallback;
        private static ManagedHostCall32 TextSetOverflowCallback;
        private static ManagedHostCall33 TextGetClipToBoundsCallback;
        private static ManagedHostCall34 TextSetClipToBoundsCallback;
        private static ManagedHostCall37 TextGetMaxLinesCallback;
        private static ManagedHostCall38 TextSetMaxLinesCallback;
        private static ManagedHostCall31 TextGetHorizontalAlignmentCallback;
        private static ManagedHostCall32 TextSetHorizontalAlignmentCallback;
        private static ManagedHostCall31 TextGetVerticalAlignmentCallback;
        private static ManagedHostCall32 TextSetVerticalAlignmentCallback;
        private static ManagedHostCall31 TextGetFontStyleCallback;
        private static ManagedHostCall32 TextSetFontStyleCallback;
        private static ManagedHostCall96 TextGetOutlineColorCallback;
        private static ManagedHostCall97 TextSetOutlineColorCallback;
        private static ManagedHostCall29 TextGetOutlineWidthCallback;
        private static ManagedHostCall30 TextSetOutlineWidthCallback;
        private static ManagedHostCall96 TextGetShadowColorCallback;
        private static ManagedHostCall97 TextSetShadowColorCallback;
        private static ManagedHostCall35 TextGetShadowOffsetCallback;
        private static ManagedHostCall36 TextSetShadowOffsetCallback;
        private static ManagedHostCall29 TextGetShadowSoftnessCallback;
        private static ManagedHostCall30 TextSetShadowSoftnessCallback;
        private static ManagedHostCall29 TextGetCharacterSpacingCallback;
        private static ManagedHostCall30 TextSetCharacterSpacingCallback;
        private static ManagedHostCall29 TextGetWordSpacingCallback;
        private static ManagedHostCall30 TextSetWordSpacingCallback;
        private static ManagedHostCall29 TextGetLineSpacingCallback;
        private static ManagedHostCall30 TextSetLineSpacingCallback;
        private static ManagedHostCall29 TextGetParagraphSpacingCallback;
        private static ManagedHostCall30 TextSetParagraphSpacingCallback;
        private static ManagedHostCall33 TextGetUseCustomDecorationColorCallback;
        private static ManagedHostCall34 TextSetUseCustomDecorationColorCallback;
        private static ManagedHostCall96 TextGetDecorationColorCallback;
        private static ManagedHostCall97 TextSetDecorationColorCallback;
        private static ManagedHostCall29 TextGetDecorationThicknessCallback;
        private static ManagedHostCall30 TextSetDecorationThicknessCallback;
        private static ManagedHostCall29 TextGetUnderlineOffsetCallback;
        private static ManagedHostCall30 TextSetUnderlineOffsetCallback;
        private static ManagedHostCall29 TextGetStrikethroughOffsetCallback;
        private static ManagedHostCall30 TextSetStrikethroughOffsetCallback;
        private static ManagedHostCall33 TextGetUseKerningCallback;
        private static ManagedHostCall34 TextSetUseKerningCallback;
        private static ManagedHostCall37 TextGetTabWidthCallback;
        private static ManagedHostCall38 TextSetTabWidthCallback;
        private static ManagedHostCall31 TextGetSortingLayerCallback;
        private static ManagedHostCall32 TextSetSortingLayerCallback;
        private static ManagedHostCall31 TextGetOrderInLayerCallback;
        private static ManagedHostCall32 TextSetOrderInLayerCallback;
        private static ManagedHostCall142 Collider2DGetMaterialOverrideCallback;
        private static ManagedHostCall143 Collider2DSetMaterialOverrideCallback;
        private static ManagedHostCall142 Collider3DGetMaterialOverrideCallback;
        private static ManagedHostCall143 Collider3DSetMaterialOverrideCallback;
