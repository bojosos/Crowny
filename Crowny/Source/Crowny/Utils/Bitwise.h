...
namespace Crowny
{
    ...
    public:
      ...
      static void IntWrite(void* dst, const int32_t n, const uint32_t value)
      {
        switch (n)
        {
          ...
          case 2:
            ...
            break;
          case 3: CW_ENGINE_ASSERT(false, "3-byte int write not implemented."); break;
          case 4:
      ...
      static uint32_t IntRead(const void* src, int32_t n)
      {
        switch (n)
        {
          case 1: return ((uint8_t*)src)[0];
          case 2: return ((uint16_t*)src)[0];
          case 3: CW_ENGINE_ASSERT(false, "3-byte int read not implemented."); break;
          case 4: return ((uint32_t*)src)[0];
          default: return 0;
        }
      }
