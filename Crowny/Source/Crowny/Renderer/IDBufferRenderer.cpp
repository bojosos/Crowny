...
namespace Crowny
{
    ...
    void IDBufferRenderer::Init()
    {
        ...
        s_Data.VertexBuffer =
          VertexBuffer::Create(sizeof(IDBufferData) * 4 * RENDERER_MAX_SPRITES, BufferUsage::DYNAMIC_DRAW);
        BufferLayout layout = { { ShaderDataType::Float4, "a_Coordinates" }, { ShaderDataType::Int, "a_ObjectID" } };
    ...
    void IDBufferRenderer::Begin(const glm::mat4& projection, const glm::mat4& view)
    {
        ...
        s_Data.Buffer =
          (IDBufferData*)s_Data.VertexBuffer->Map(0, RENDERER_MAX_SPRITES * 4, GpuLockOptions::WRITE_DISCARD);
