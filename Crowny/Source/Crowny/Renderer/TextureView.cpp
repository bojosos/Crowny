...
namespace Crowny
{
    ...
    {
        return lhs.MostDetailedMip == rhs.MostDetailedMip && lhs.NumMips == rhs.NumMips && lhs.FirstArraySlice == rhs.FirstArraySlice && lhs.NumArraySlices == rhs.NumArraySlices && lhs.Usage == rhs.Usage;
    }
