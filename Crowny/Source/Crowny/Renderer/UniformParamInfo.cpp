...
namespace Crowny
{
    ...
    void UniformParamInfo::GetBinding(ShaderType type, ParamType paramType, const std::string& name, UniformBinding& binding)
    {
    ...
    Ref<UniformParamInfo> UniformParamInfo::Create(const UniformParamDesc& desc)
    {
        switch (Renderer::GetAPI())
		{
			...
			case RendererAPI::API::Vulkan: return CreateRef<VulkanUniformParamInfo>(desc);
