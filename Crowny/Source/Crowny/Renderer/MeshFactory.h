...
namespace Crowny
{
    ...
    public:
        ...
        static Ref<MeshData> CreateQuadData(float width = 1.0f, float height = 1.0f, const glm::vec3& normal = glm::vec3(0.0f, 1.0f, 0.0f));
        ...
        static Ref<Mesh> CreateQuad(float width = 1.0f, float height = 1.0f, const glm::vec3& normal = glm::vec3(0.0f, 1.0f, 0.0f),
