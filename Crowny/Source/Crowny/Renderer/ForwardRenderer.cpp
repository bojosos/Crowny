...
/*
    ...
    {/*
        s_Data.VSSystemUniformBufferSize = sizeof(glm::mat4) + sizeof(glm::mat4) + sizeof(glm::vec3) +
sizeof(glm::mat4); s_Data.VSSystemUniformBuffer = new byte[s_Data.VSSystemUniformBufferSize];
        ...
        s_Data.VSSystemUniformBufferOffsets[VSSystemUniformIndex_ViewMatrix] =
s_Data.VSSystemUniformBufferOffsets[VSSystemUniformIndex_ProjectionMatrix] + sizeof(glm::mat4);
        s_Data.VSSystemUniformBufferOffsets[VSSystemUniformIndex_ModelMatrix] =
s_Data.VSSystemUniformBufferOffsets[VSSystemUniformIndex_ViewMatrix] + sizeof(glm::mat4);

        s_Data.VSSystemUniformBufferOffsets[VSSystemUniformIndex_CameraPosition] =
s_Data.VSSystemUniformBufferOffsets[VSSystemUniformIndex_ModelMatrix] + sizeof(glm::mat4);
