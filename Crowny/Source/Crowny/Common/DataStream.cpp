...
namespace Crowny
{
    ...
    FileDataStream::FileDataStream(const std::filesystem::path& path, AccessMode accessMode, bool freeOnClose) : DataStream(accessMode), m_Path(path), m_FreeOnClose(freeOnClose)
    {
