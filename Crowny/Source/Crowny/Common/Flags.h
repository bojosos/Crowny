...
namespace Crowny
{
    ...
    public:
        ...
        {
            return static_cast<uint8_t>(m_Bits);
        }
        
        operator uint16_t() const
        {
            return static_cast<uint16_t>(m_Bits);
        }
        
        operator uint32_t() const
        {
            return static_cast<uint32_t>(m_Bits);
        }
...
#define CW_FLAGS_OPERATORS(Enum) \
    inline Flags<Enum, uint32_t> operator|(Enum a, Enum b) { Flags<Enum, uint32_t> r(a); r |= b; return r; } \
    inline Flags<Enum, uint32_t> operator&(Enum a, Enum b) { Flags<Enum, uint32_t> r(a); r &= b; return r; } \
