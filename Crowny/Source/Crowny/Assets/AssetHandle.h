...
namespace Crowny
{
	...
	template <bool Weak>
	class TAssetHandleBase : public AssetHandleBase
	{ };

	template <>
	class TAssetHandleBase<true> : public AssetHandleBase
	{
	protected:
		void AddRef() { }
		void ReleaseRef() { }
	...
	template <>
	class TAssetHandleBase<false> : public AssetHandleBase
	{
	protected:
		void AddRef()
		{
	...
	class TAssetHandle : public TAssetHandleBase<Weak>
	{
	public:
	...
	template <typename T>
	using AssetHandle = TAssetHandle<T, false>;

	template <typename T>
	using WeakAssetHandle = TAssetHandle<T, true>;
