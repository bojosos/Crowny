...
public:
    BinaryDataStreamOutputArchive(const Ref<DataStream>& stream) :
            OutputArchive<BinaryDataStreamOutputArchive, AllowEmptyClassElision>(this),
            m_Stream(stream) { }
...
class BinaryDataStreamInputArchive : public InputArchive<BinaryDataStreamInputArchive, AllowEmptyClassElision>
{
    ...
    BinaryDataStreamInputArchive(const Ref<DataStream>& stream) :
                InputArchive<BinaryDataStreamInputArchive, AllowEmptyClassElision>(this),
                m_Stream(stream) { }
...
CEREAL_SAVE_FUNCTION_NAME(BinaryDataStreamOutputArchive & ar, T const & t)
{
...
template<class T> inline
typename std::enable_if<std::is_arithmetic<T>::value, void>::type
CEREAL_LOAD_FUNCTION_NAME(BinaryDataStreamInputArchive & ar, T & t)
{
...
CEREAL_ARCHIVE_RESTRICT(BinaryDataStreamInputArchive, BinaryDataStreamOutputArchive)
...
//! Saving binary data
template <class T> inline
void CEREAL_SAVE_FUNCTION_NAME(BinaryDataStreamOutputArchive & ar, BinaryData<T> const & bd)
{
...
//! Loading binary data
template <class T> inline
void CEREAL_LOAD_FUNCTION_NAME(BinaryDataStreamInputArchive & ar, BinaryData<T> & bd)
{
