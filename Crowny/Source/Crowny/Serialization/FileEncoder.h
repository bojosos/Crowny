...
namespace Crowny
{
	...
	template <typename T, SerializerType S = SerializerType::Auto>
	class FileEncoder;

	template <typename T>
	class FileEncoder<T, SerializerType::Binary>
	{
	public:
	...
	template <typename T>
	class FileEncoder<T, SerializerType::Yaml>
	{
	public:
		FileEncoder(const Path& path) : m_OutputPath(path) { }
	...
	template <typename T>
	class FileEncoder<T, SerializerType::Auto>
	{
	public:
		FileEncoder(const Path& path) : m_OutputPath(path) { }
	...
	template <typename T>
	class FileDecoder<T, SerializerType::Binary>
	{
	public:
	...
	template <typename T>
	class FileDecoder<T, SerializerType::Yaml>
	{
	public:
		FileDecoder(const Path& path) : m_InputPath(path) { }
	...
	template <typename T>
	class FileDecoder<T, SerializerType::Auto>
	{
	public:
