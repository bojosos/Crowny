...
namespace Crowny
{
    ...
    public:
        ...
        bool GetSerializableObjectInfo(const SerializableTypeInfoObject& typeInfo, Ref<SerializableObjectInfo>& outInfo);
        bool GetSerializableObjectInfo(MonoClass* monoClass, Ref<SerializableObjectInfo>& outInfo);
