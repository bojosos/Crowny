...
namespace Crowny
{
    ...
    {
		template <>
        String ScriptArray_Get<String>(MonoArray* ar, uint32_t idx)
        {
            return MonoUtils::FromMonoString(mono_array_get(ar, MonoString*, idx));
        }

		template <>
        Path ScriptArray_Get<Path>(MonoArray* ar, uint32_t idx)
        {
            return MonoUtils::FromMonoString(mono_array_get(ar, MonoString*, idx));
        }

        template <>
		void ScriptArray_Set<String>(MonoArray* ar, uint32_t idx, const String& value)
		{
		...
		template <>
		void ScriptArray_Set<Path>(MonoArray* ar, uint32_t idx, const Path& value)
		{
		...
		template<>
		void ScriptArray_Set<std::nullptr_t>(MonoArray* ar, UINT32 idx, const std::nullptr_t& value)
		{
