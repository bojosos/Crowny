...
namespace Crowny
{
  ...
  std::unordered_map<uint32_t, ScriptComponent::ComponentInfo> ScriptComponent::s_ComponentInfos;
    ...
    s_TypeMap[assembly->GetClass("Crowny", "Transform")->GetInternalPtr()] = entt::type_info<TransformComponent>::id();
    s_TypeMap[assembly->GetClass("Crowny", "MeshRenderer")->GetInternalPtr()] = entt::type_info<MeshRendererComponent>::id();
    s_TypeMap[assembly->GetClass("Crowny", "SpriteRendererComponent")->GetInternalPtr()] = entt::type_info<SpriteRendererComponent>::id();
    s_TypeMap[assembly->GetClass("Crowny", "CameraComponent")->GetInternalPtr()] = entt::type_info<CameraComponent>::id();
