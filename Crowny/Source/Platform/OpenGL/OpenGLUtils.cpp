...
namespace Crowny
{
    ...
    String OpenGLUtils::StorageBlockName(uint32_t set, uint32_t slot) { return "cw_Storage_" + std::to_string(set) + "_" + std::to_string(slot); }
    ...
    OpenGLTextureFormat OpenGLUtils::TextureFormatToOpenGL(TextureFormat format, bool sRGB)
    {
        ...
        case TextureFormat::RGB8:
            return { static_cast<GLenum>(sRGB ? GL_SRGB8 : GL_RGB8), GL_RGB, GL_UNSIGNED_BYTE, false };
        case TextureFormat::RGBA8:
            return { static_cast<GLenum>(sRGB ? GL_SRGB8_ALPHA8 : GL_RGBA8), GL_RGBA, GL_UNSIGNED_BYTE, false };
        case TextureFormat::BGRA8:
            return { static_cast<GLenum>(sRGB ? GL_SRGB8_ALPHA8 : GL_RGBA8), GL_BGRA, GL_UNSIGNED_BYTE, false };
        ...
        case TextureFormat::RGB16:
            return { GL_RGB16, GL_RGB, GL_UNSIGNED_SHORT, false };
        ...
        case TextureFormat::BC4:
            return { GL_COMPRESSED_RED_RGTC1, GL_NONE, GL_NONE, true };
        case TextureFormat::BC5:
            return { GL_COMPRESSED_RG_RGTC2, GL_NONE, GL_NONE, true };
        case TextureFormat::BC6H:
            return { GL_COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT, GL_NONE, GL_NONE, true };
        ...
        case TextureFormat::ETC2_R11:
            return { GL_COMPRESSED_R11_EAC, GL_NONE, GL_NONE, true };
        case TextureFormat::ETC2_RG11:
            return { GL_COMPRESSED_RG11_EAC, GL_NONE, GL_NONE, true };
        case TextureFormat::ASTC4x4:
            return { sRGB ? COMPRESSED_SRGB8_ALPHA8_ASTC_4X4 : COMPRESSED_RGBA_ASTC_4X4, GL_NONE, GL_NONE, true };
        case TextureFormat::NONE:
        case TextureFormat::FormatCount:
            break;
        }
