...
namespace Crowny
{
    ...
    VulkanGpuBufferManager::VulkanGpuBufferManager()
    {
        ...
        // m_DummyReadBuffer = new VulkanGpuBuffer(VulkanGpuBuffer::BUFFER_GENERIC, BF_32X1F, BufferUsage::BU_STATIC_DRAW, 16);
        // m_DummyStorageBuffer = new VulkanGpuBuffer(VulkanGpuBuffer::BUFFER_GENERIC, BF_32X1F, BufferUsage::BU_LOADSTORE, 16);
        // m_DummyStructuredBuffer = new VulkanGpuBuffer(VulkanGpuBuffer::BUFFER_GENERIC, BF_UNKNOWN, BufferUsage::BU_LOADSTORE, 16);
    }
