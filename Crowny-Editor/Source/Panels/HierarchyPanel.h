...
namespace Crowny
{
    ...
    private:
        ...
        void CollectMatchingEntities(Entity e, Entity root, Vector<Entity>& results) const;
        const String& BuildParentPath(Entity e, Entity root);
    ...
    private:
        ...
        Vector<std::function<void()>> m_DeferredActionScratch;
        SelectionChangedCallback m_SelectionChanged;
        Entity m_Renaming = {};
        String m_RenamingString;
        String m_SearchFilter;
        String m_FoldedSearchFilter;
        EntitySelection m_Selection;
        Vector<Entity> m_VisibleEntities;
        Vector<Entity> m_SearchMatches;
        Vector<StringView> m_ParentPathSegments;
        String m_ParentPathScratch;
