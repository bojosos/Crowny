project "Crowny-Tests"
	...
	files
	{
		...
		"%{wks.location}/Crowny-Editor/Source/Editor/DecalBoundsInteraction.cpp",
		...
		"%{wks.location}/Crowny-Editor/Source/Editor/MaterialInspectorTransaction.cpp",
        ...
        "%{wks.location}/Crowny-Editor/Source/Editor/SceneGizmos.cpp",
		"%{wks.location}/Crowny-Editor/Source/Editor/ViewportAssetDrop.cpp",
